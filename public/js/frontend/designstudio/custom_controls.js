...
(function(window) {
    ...
    fabric.util.object.extend(fabric.Object.prototype, {
        ...
        drawControls: function(ctx) {
            ...
            var wh = this._calculateCurrentDimensions(),
                width = wh.x + this.cornerPadding,
                height = wh.y + this.cornerPadding,
        ...
        _drawControl: function(control, ctx, methodName, left, top, icon, settings) {
            ...
            var size = this.cornerSize,
                ...
                cornerPadding = typeof this.cornerPadding === 'number' ? this.cornerPadding : 0;
            ...
            if (this.useCustomIcons) {
                if (cornerShape) {
                    ...
                    switch (cornerShape) {
                        ...
                        case 'circle':
                            ctx.beginPath();
                            ctx.arc(left + size , top + size, size , 0, 2 * Math.PI);
                            ctx.fill();
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _removeAction: function(e, target) {
            ...
            if(canvasActive.getActiveGroup()){
                canvasActive.getActiveGroup().forEachObject(function(o){ canvasActive.remove(o) });
                canvasActive.discardActiveGroup().renderAll();
              } else {
