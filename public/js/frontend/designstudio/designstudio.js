...
{
    var today = new Date();
    if(getDeliveryDateObj(today, 0) == today && today.getHours() > 9 &&  today.getMinutes() > 0 &&  today.getSeconds() > 0 && today.getHours() < 17 && today.getMinutes() < 59 && today.getSeconds() < 59)
    {
        document.getElementById("lifechat").style.display='block';
    }
    ...
    $.ajax({
        ...
        success: function(text) {
            ...
            var json = text[0];
 			...
 			idproduct = file.split("/")[3].split('_')[1];

			//console.log(file.split("/")[3].split('_')[1]);
...

{
...

    {
        ...
        ShowAlert('minimunalert', 'The minimun quantity requiered for this product is 6', 'danger', 'Attention');
...

    {
...

            {
...

                {
...

                    {
                        ...
                        ShowAlert('Message15', 'Please enter a Design Name without space or special charapter!', 'danger', 'Attention!');
...

                    {
...

                        {
                            ...
                            ShowConfirmAlert('Message14', 'You have a previous design saved with this name. Do you want override this design!', 'warning', 'Attention!');
...

                {
...

                    {
                        ...
                        ShowAlert('Message13', 'Please enter a Design Name and email to continue!', 'danger', 'Attention!');
...

                    {
                        ...
                        ShowAlert('Message11', 'Please enter a Design Name to continue!', 'danger', 'Attention!');
...

                    {
                        ...
                        ShowAlert('Message12', 'The email format is incorrect. Please enter a valid email address to continue!', 'danger', 'Attention!');
        ...
        case 'sendemail':
...

                {
...

                    {
...

                        {
                            ...
                            ShowAlert('Message15', 'Please enter a Design Name without space!', 'danger', 'Attention!');
...

            {
                ...
                ShowAlert('fillform', 'You must fill all form(s)!', 'danger', 'Attention!!');
        ...
        case 'SaveContinueOnly':
...

            {
...

                {
                    ...
                    ShowConfirmAlert('Message15', 'You have a previous design saved with this name. Do you want override this design!', 'warning', 'Attention!');
...

{
    ...
    {      
		...
		textarea_btn.innerHTML = "Update Text";
...
$('#zoomin').click(function() {
    ...
    var valueaddrigth = 0.35;

    var valueaddback = 0.5;
...
var input = document.querySelector("[name=designName]");
input.oninput = function(event) {
    event.target.setCustomValidity("");
};

var input = document.querySelector("[name=designNameOnly]");
input.oninput = function(event) {
    event.target.setCustomValidity("");
};

var input = document.querySelector("[name=designnameshare]");
input.oninput = function(event) {
    event.target.setCustomValidity("");
};
