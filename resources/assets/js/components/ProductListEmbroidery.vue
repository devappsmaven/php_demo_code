        ...
        <div class="col-lg-4" id="filters-colum">
            ...
            <div class="ds-search-left">
                <div class="panel-group">
                    ...
                    <div id="collapsefamilycolor" class="panel-collapse collapse in">
            ...
            <!--<div class="ds-colors-left" style="border: 1px solid; padding: 15px; overflow-y: scroll; height: 300px; width:95%; display:none;">
            <h3>Color</h3>
            <form>
                <div class="checkbox" v-for="familycolor in familycolors" :key="familycolor.id">
                    <label>
                        <input type="checkbox" v-model="filtersSelected" :value="familycolor.name" v-bind:id="familycolor.name"  v-on:change="getfilteredData">
                        {{familycolor.name}}
                    </label>
                </div>
            </form>
            ...
            <div class="ds-search-left">
                <div class="panel-group">
                    ...
                    <div id="collapsefabric" class="panel-collapse collapse in">
...
export default {
    data() {
        return {
            ...
            brands:[],
            fabrics:[],
            urlProducts : window.location.origin + '/vivid_test/api/productenablegridembroidery',
            urlChildProducts : window.location.origin + '/vivid_test/api/childproductsembroidery',
