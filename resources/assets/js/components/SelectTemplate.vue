...
<script>
 export default {
    ...
    methods:{
        ...
        {
            $("#category_id").empty();
            $.getJSON(window.location.origin + "/vivid_test/api/templatecategoryembroidery", function(categories)
            {
        ...
        {   
            ...
            $.getJSON(window.location.origin + "/vivid_test/api/templatesubcategoryembroiderylist/"+category_id, function(subcategories)
            {
