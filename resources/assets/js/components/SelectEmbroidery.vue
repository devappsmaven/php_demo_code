...
<script>
 export default {
    ...
    methods:{
        ...
        {
            $("#category_id").empty();
            $.getJSON(window.location.origin + "/vivid_test/api/clipartcategoryembroiderylist", function(categories)
            {
        ...
        {   
            ...
            $.getJSON(window.location.origin + "/vivid_test/api/clipartsubcategoryembroiderylist/"+category_id, function(subcategories)
            {
