        ...
        <div id="TemplateMenu" class="panel panel-info">
            ...
            <div id="TemplateTable">
                    ...
                    <div class="text-center">
                        <div class="col-md-4 col-xs-6" v-for="category in categories" :key="category.id">
                            <a href="javascript:void(0);"  v-on:click="setcategory(category)">
                                <img v-bind:src=" path + '/img/category/' + category.filename"  class="ds-template" v-bind:style="'padding: 1em; background-color:' + category.background">
                                <div class="caption">
                                    <p>{{category.name}}</p>
                                </div>
                            </a>
                ...
                <div id="div-templatesubcategories" style="display:none">
                    <div class="text-center">
                        <div class="col-sm-4 col-xs-6" v-for="subcategory in subcategories" :key="subcategory.id">
                ...
                <div id="div-templates" style="display:none">
                    <div class="text-center">
                        <div class="col-sm-4 col-xs-6" v-for="template in templates" :key="template.id">
                            <a href="javascript:void(0);" v-on:click="loadtemplatedesigns(template.title)">
                                <img v-bind:src=" path + '/designs/template/'+ templates.category + '/' + templates.subcategory + '/' + template.title + '_' + template.defaultside + '_preview.png'"  class="ds-template" v-bind:style="'background-color:'+template.background/*padding: 1em;*/">
                                <div class="caption">
                ...
                <div id="div-filtertemplates" style="display:none">
                    <div class="text-center">
                        <div class="col-sm-4 col-xs-6" v-for="template in alltemplates" :key="template.id">
                            <a href="javascript:void(0);" v-on:click="loadtemplatedesigns(template.title)">
                                <img v-bind:src=" path + '/designs/template/'+ templates.category + '/' + templates.subcategory + '/' + template.title + '_' + template.defaultside + '_preview.png'"  class="ds-template" v-bind:style="'background-color:'+template.background/*padding: 1em;*/">
                                <div class="caption">
                                    <p>{{template.displayname}}</p>
