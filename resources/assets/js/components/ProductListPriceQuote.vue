...
export default {
    data() {
        return {
            ...
            products: [],
            urlProductCategories : window.location.origin + '/vivid_test/api/productcategoryenable',
            urlProductSubCategories : window.location.origin + '/vivid_test/api/productsubcategoryenable',
            urlProducts : window.location.origin + '/vivid_test/api/product/category',
