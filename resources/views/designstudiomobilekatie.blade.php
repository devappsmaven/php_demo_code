                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                   <ol class="undoredo">
                    ...
                    <a class="left carousel-control" >
                        <span class="glyphicon glyphicon-chevron-left ds-chevron" style="color:#31B0D5; font-size: 45px;" href="#myCarousel" data-slide="prev" onclick="setcanvas('previous');"></span>
