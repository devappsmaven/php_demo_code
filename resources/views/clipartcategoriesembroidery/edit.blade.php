...
@section('title','Edit Clipart Category Embroidery')
...
<div class="box">
    <div class="box-header">
        <h3 class="box-title">Edit Clipart Category Embroidery</h3>
    </div>
    <div class="box-body">
        <form role="form" method="POST" action="/admin/clipartcategoriesembroidery/{{ $clipartcategoryembroidery->id}}" enctype="multipart/form-data" class="colors_form" novalidate="novalidate">
            {{csrf_field()}}
            {{method_field('PUT')}}
            <div class="row">
                <div class="col-md-3">
                        ...
                        <div class="modal-body">
                            <div class="box-body">
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <input type="text" class="form-control" name="title" value="{{ $clipartcategoryembroidery->title}}">
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group{{ $errors->has('filename') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <img class="profile-user-img img-responsive" src="{{asset('img/clipart-embroidery')}}{{ '/'}}{{ $clipartcategoryembroidery->slug }}{{ '/'}}{{ $clipartcategoryembroidery->filename }}" alt="User profile picture">
                                ...
                                <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }} has-feedback">
                                    ...
                                    <select class="form-control" name="status">
                                        @if($clipartcategoryembroidery->status == 'Enable')
                                            <option selected>Enable</option>
                                            <option>Disable</option>
                                        @endif
                                        @if($clipartcategoryembroidery->status == 'Disable')
