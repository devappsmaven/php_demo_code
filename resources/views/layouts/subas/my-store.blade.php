                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form method="POST" action="{{ route('stores.updateinfo',Auth::user()->store->id) }}"  enctype="multipart/form-data">
                                            ...
                                            <div class="login-account p-30 box-shadow">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                    <input type="text" name="newname" placeholder="Store Name ..." value="{{Auth::user()->store->name}}">
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input type="text" name="newslogan" placeholder="Store Slogan ..."  value="{{Auth::user()->store->slogan}}">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <button class="submit-btn-1 mt-20 btn-hover-1" type="submit" value="register">Change</button>
                                                    </div>
                                                </div>
                                            </div>    
                                        </form>
                                                    ...
                                                    @if(Auth::user()->store->statusname == 'Waiting Approval' || Auth::user()->store->statusname == 'Rejected')
                                                        <div class="col-sm-6">
                                                           @if(Auth::user()->store->statusname == 'Waiting Approval')
                                                                <input type="text" value="{{Auth::user()->store->newname}}" readonly>
                                                                <br>
                                                    ...
                                                    @if(Auth::user()->store->statuslogan == 'Waiting Approval' || Auth::user()->store->statuslogan == 'Rejected')
                                                        <div class="col-sm-6">
                                                            @if(Auth::user()->store->statuslogan == 'Waiting Approval')
                                                                <input type="text" value="{{Auth::user()->store->newslogan}}" readonly>
                                                                <br>
                                                                <strong class="alert alert-warning"><strong>Warning!</strong> Your change is waiting for approval.</strong>
