...
<table width='550' border='0' cellspacing='0' cellpadding='0' align='center'>
    <tbody>
        <tr>
        <td align='left'>
            <img src='http://vividcustoms.test/img/logo/vividcustoms-logo-small3.png' width='250' height='auto'>
        </td>
        <td align='right'>
...
<p align="center" style="color: black;">Design Name: {{$design->name}}</p>
<table align="center">
    <tbody>
        <tr>
...
<tr>
    <th>
    <a href="http://vividcustoms.test/designstudio/e/{{$design->title}}"  target="_blank" tabindex="0" style="cursor: pointer; background-color: #e62a9a; border: 0 none; text-decoration: none; border-radius: 20px; box-shadow: 0 0 0 1px rgba(79, 193, 240, 0.03) inset; cursor: pointer; display: inline-block; margin-right: 10px; overflow: hidden; padding: 5px 10px; position: relative; background-color: rgba(230, 42, 154, 0.8); color: #ffffff !important; font-size: 15px;">
            <span style="font-weight: bold;font-size: 18px; padding: 5px 10px;">Edit Design</span>
        </a>
    </th>
    <th>
        <a href="http://vividcustoms.test/designstudio/e/{{$design->title}}"  target="_blank"  tabindex="0" style="cursor: pointer; background-color: #e62a9a ; border: 0 none; text-decoration: none;
                border-radius: 20px;
