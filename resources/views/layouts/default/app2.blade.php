...
<head>
    ...
    @endif
    <link rel="stylesheet" href="{{asset('css/frontend/default/bootstrap.css')}}@php echo '?v='.rand(); @endphp">
    <link rel="stylesheet" href="{{asset('css/frontend/default/bootstrap.min.css')}}@php echo '?v='.rand(); @endphp">
    ...
    <link rel="stylesheet" href="{{asset('css/frontend/default/new-style.css')}}">
...
<body>
    ...
    <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
      ...
      <script src="{{asset('js/frontend/default/bootstrap.js')}}@php echo '?v='.rand(); @endphp"></script>
      <script src="{{asset('js/frontend/default/bootstrap.min.js')}}@php echo '?v='.rand(); @endphp"></script>
      <script src="{{asset('js/frontend/default/custom.js')}}@php echo '?v='.rand(); @endphp"></script>
      <script src="{{asset('js/frontend/default/lightslider.js')}}@php echo '?v='.rand(); @endphp"></script>
