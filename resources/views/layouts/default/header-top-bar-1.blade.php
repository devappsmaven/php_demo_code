            ...
            <div class="container_fixed">
                <div class="top_icons">
                    <div class="price_bg">
                        ...
                        <span><a href="{{url('price-quote')}}">Price Quote</a></span>
                    ...
                    <div class="price_bg">
                        ...
                        <span><a href="{{url('login')}}">My Account</a></span>
                    </div>
                    <div class="price_bg">
                        <img src="{{asset('images/cart.png')}}"/>
                        <span><a href="{{url('login')}}">My Store</a></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="top_icons">
                        ...
                        <span>
                            <div class="dropdown" style="cursor:pointer;">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <h5 class="dropdown-header"><a href="{{url('my-account')}}"><span style="color:#6c757d;"><i class="fa fa-user"></i>  My Account</span></a></h5>
                    ...
                    <div class="price_bg">
                        ...
                        <?php if(in_array('Store Designer', Auth::user()->roles->pluck('name')->toArray())): ?>
                            <span><a href="{{url('my-store')}}">My Store</a></span>
                        <?php else: ?>                                                    
                            <span><a href="{{url('store-subscribe')}}">My Store</a></span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
    ...
    @endauth
        ...
        <div class="container_fixed">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a class="design_btn" href="{{url('designstudio')}}"><center>Start Designing</center> </a>
