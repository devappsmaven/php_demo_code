...
<section class="" id="product_page" style="float: left; width: 100%; padding:10px;">
    ...
    <div class="row column_heading">       
        <div class="col-sm-3 product_sidebar">     
            <form action="{{ url('/products-filter-studio') }}" method="post" class="column_heading"> {{csrf_field()}}
                            ...
                            <div id="{{$category->slug}}" class="collapse" aria-labelledby="collapseOne" data-parent="#accordionproducts">
                                <div class="card-body">
                                    <ul>
                                        ...
                                        <li><input name="categoryFilter[]" type="checkbox" id="{{$category->slug}}-FilterCategory" value="ViewAll" onchange="filterall(this,'/product-list-studio?');"  @if(!empty($categoryArray) && in_array(($category->slug."/ViewAll"),$categoryArray) && in_array("/ViewAll",$categoryArray)) checked="" @endif>
                                            <span> View All </span>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="card-body">
                                <ul>
                                    @foreach ($brandslist as $brand)
                                        ...
                                        @endif
                                    @endforeach
                                    <li><input type="checkbox"name="brandFilter[]" id="FilterBrandViewAll" value="ViewAll" onchange="filterall(this,'/product-list-studio?');" @if(!empty($brandArray) && in_array('ViewAll',$brandArray)) checked="" @endif><span> View All </span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="all-fabrics" class="collapse" aria-labelledby="collapseFabric" data-parent="#accordionfabrics">
                            <div class="card-body">
                                <ul>
                                    ...
                                    @endforeach
                                    <li><input type="checkbox"name="fabricFilter[]" id="FilterFabricViewAll" value="ViewAll" onchange="filterall(this,'/product-list-studio?');" @if(!empty($fabricArray) && in_array('ViewAll',$fabricArray)) checked="" @endif><span> View All </span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
