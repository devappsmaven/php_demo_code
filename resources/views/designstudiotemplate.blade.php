...
.ds-work-area{position: relative; display: block; overflow-y: scroll; }
...
<body>
                            ...
                            <div class="row" id="SaveShareModalDiv">
                                ...
                                <hr style="margin-top: 10px; margin-bottom: 10px; background-color: #4598ba; height: 2px; border: 0;">
                                    ...
                                    <div class="panel panel-info" id="share_div" name="share_div">
                                        ...
                                        <div class="panel-heading">
                                            <center>
                                                <span class="uppercase">Save as Guest</span>
                                            </center>
                                        </div>
                                        <div class="panel-body">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-5">
                                            <div class="row">
                                                <div class="col-xs-6 col-xs-6 col-xs-3 col-xs-3 thumbnail2">
                                        ...
                                        <div class="col-xs-7" style="border-left:1px solid #ccc;height:160px">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-2" for="designName">Name</label>
                                                    <div class="col-xs-10">
                                                        <input type="text" class="form-control" id="designName" placeholder="Enter Design Name" name="designName">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-xs-2" for="designemail">E-mail:</label>
                                                    <div class="col-xs-10">
    ...
    <script type="text/javascript">
        ...
        var shoppingcart = null; //new { subtotal:0, tax:0, shipping_cost:0, discount:0, total:0, status:"created", date:null, shipby:null, promocode:'', items:[], user:null}
        var position = 0;
        ...
        window.onload = function() 
        {
            ...
            $.ajax({
                ...
                {  
                    ...
                    currentdesign = {arrayside :[], name:'',product:product, type:"Designstudio", num_shirts:0, price_per_shirt:0, total:0};//shoppingcart.items.length == 0 ?  {arrayside :[], name:'',product:product, type:"Designstudio", num_shirts:0, price_per_shirt:0, total:0} : shoppingcart.items[position];
                    enableproductsizes();
        ...
        */
        ...
        function loademaildesigns(saveddesignname)
        {
            pos = 0;
        ...
        */
        ...
        { 
            ...
            */
            ...
            if (num > 0)
            {
                ...
                {
                    var scale = 0.15;
                    getpriceimages+=' <div class="col-xs-6 col-xs-6 col-xs-3 col-xs-3 thumbnail2"><label for="'+printarea.canvas.name+'colors" id="'+printarea.canvas.name+'colors" name="'+printarea.canvas.name+'colors" style="font-size: 1.1rem;"></label><div style="background-size: cover; background-position: center center;border: 1px solid;background-image: url('+window.location.origin+'/img/product/'+printarea.productimg+');position: relative;margin: auto;width: 743px;height: 810px; webkit-transform-origin: 0 0; transform-origin: 0 0; -webkit-transform: scale('+scale+') translate(-50%); transform: scale('+scale+') translate(-50%); left: 50%;"><img class="PreviewSave" src="'+printarea.img+'" class="img-responsive" style="position: absolute; width: '+printarea.width+'px; height: '+printarea.height+'px; top: '+printarea.top+'px; left:'+printarea.left+'px;"></div></div>';
                    //getpriceimages+=' <div class="col-xs-6 col-xs-6 col-xs-3 col-xs-3 thumbnail2"><label for="frontcolos" id="frontcolos" name="frontcolos" style="font-size: 1.1rem;"></label><div id="frontSavedDesingPreview" style="background-repeat: no-repeat; background-size: cover; background-position: center center; border: 1px #000000 solid;"><img id="frontSavePreview" src="" alt="" class="img-responsive"></div></div>';
                });
        ...
        {            
            ...
            $.ajax({
                ...
                dataType: 'json', 
                data: {
                        /*svg: currentdesign.svg,
                        json: currentdesign.json,
                        toDataURL: currentdesign.toDataURL,*/
                        email: currentdesign.email,
                        name: currentdesign.name,
                        product: currentdesign.product.id,
                        design: JSON.parse(JSON.stringify(design)),
                        categories: document.geteleme
                    },
