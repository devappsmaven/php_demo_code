...
<head>
    ...
    <title>Order Sheet{{$order->id}}</title>
                        ...
                        @if(count($design->designsides) == 1)
                            <div class="col-md-4"></div>
                                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                                    <img class="order_details" src="http://{{$design->designsides[0]->design_product_image}}">
                                </div>
                            <div class="col-md-4"></div>
                        @elseif(count($design->designsides) == 2)
                            <div class="col-md-2"></div>
                                @foreach($design->designsides as $side)
                                    <div class="col-md-4">
                                        <img class="order_details" src="http://{{$side->design_product_image}}">
                                    </div>
                                @endforeach
                            <div class="col-md-2"></div>
