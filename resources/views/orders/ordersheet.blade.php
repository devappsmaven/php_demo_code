...
@section('title','Order Sheet')
@section('pagename','Order Sheet')
@section('menuname','Order Sheet')
@section('content')
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> Order Sheet
      ...
      <div class="row text-center">
        ...
        <div class="row no-print">
          <div class="col-xs-12">
           <!-- <a href="{{ URL::to('/admin/ordersheetprint/'.$order->id) }}" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
              <button class="btn btn-success pull-right"><i class="fa fa-credit-card"></i> Submit Payment</button>
            <button class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Generate PDF</button>-->
            <a class="btn btn-default pull-right" href="{{ URL::to('/admin/ordersheetpdf/'.$order->id) }}"  target="_blank"><i class="fa fa-download"></i>Generate PDF</a>
          </div>
        </div>
      </section><!-- /.content -->
