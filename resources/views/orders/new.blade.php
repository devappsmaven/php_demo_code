...
<div class="box">
    ...
    <div class="box-body">
        <center>
            <a class="btn btn-app asigned_all" style="cursor:pointer; background-color: #32a7e0; border-color: #32a7e0; color: white;" data-toggle="modal" data-target="#asigned-all-width-modal" data-url="{!! URL::route('orders.asignedall') !!}" data-token="{{ csrf_token() }}">
        ...
        <tbody>
            @foreach ($orders as $order)
                <tr>
                    ...
                    <td>{{$order->items}}</td>
                    <td>
                        <a class="btn btn-link btn-sm waves-effect waves-light asigned_to" style="cursor:pointer;" data-toggle="modal" data-target="#asigned-to-width-modal" data-url="{!! URL::route('orders.asignedto',$order->id) !!}" data-id="{{$order->id}}" data-token="{{ csrf_token() }}">
        ...
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="custom-width-modalLabel">Asign All Orders</h4>
                </div>
    ...
    <div id="cancel-modal" class="modal modal-default fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h4 class="modal-title" id="cancel-width-modalLabel">cancel Template Design</h4>
                </div>
                <div class="modal-body">
                    <h4>You Want You Sure cancel This Template Design?</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger waves-effect remove-data-from-delete-form" data-dismiss="modal">Close</button>
