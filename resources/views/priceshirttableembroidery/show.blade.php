...
<div class="box">
   <div class="box-header">
    <h3 class="box-title">Price Shirt Table Embroidery</h3>
      @can('priceshirttableembroidery.store')
      {!!Form::open(['route' => 'priceshirttableembroidery.store'])!!}
      ...
      {!!Form::close()!!}
      @endcan
      <a href="{{route('priceshirttableembroidery.create')}}" class="btn-success  btn-sm pull-right">
          generate again
      </a>
    </div><!-- /.box-header -->
    <!-- /.box-header -->
