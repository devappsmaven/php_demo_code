...
@section('title','Posts SubCategories')
@section('pagename','Posts SubCategories')
@section('menuname','Posts SubCategories')
@section('content')
<div class="row" style="margin-top:50px;">    
    ...
    <div class="col-md-6">       
        ...
        <form role="form" method="POST" action="{{route('posts.addsubcategories')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
