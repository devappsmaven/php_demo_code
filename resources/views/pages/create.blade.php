                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }} has-feedback">
                            ...
                            <textarea class="form-control" name="meta_description" maxlength="156" placeholder="120 to 156 characters" rows="5"></textarea>
                        ...
                        <div class="form-group{{ $errors->has('meta_key') ? ' has-error' : '' }} has-feedback">
                            ...
                            <input type="text" class="form-control" name="meta_key" maxlength="170" placeholder="20 to 170 characters">
