...
.save-design{margin-right:0px !important; margin-left: 0px !important}
.save-design .panel-heading{background-color: #eaeaea !important;}
.productsizes2 label{font-size: 12px;}
.sizediv-font{color: #000000;font-weight: 600;}

.color-div{padding-left:0px !important;padding-right:0px !important;margin-bottom: 40px !important;}

.ds-hr{
  margin-top: 2px;
  margin-bottom: 2px;
  display: block;
  border-top: 1px solid #dab2cf;
}
.ds-panel-body{
  margin-left:0px;
  margin-right: 0px;
...
.collapsestart, .collapsestart:link{
  font-size:12px;
...
.collapsestart:hover, .collapsestart:active{
...
.ds-nav{border:none;}
.ds-nav .ds-li{border:none;  margin-bottom: 10px !important;}
...
.ds-nav .ds-a{color:#ffffff !important;margin:0 !important;padding-top:1vh;padding-bottom:1vh;font-size:12px;border:none !important;outline:none;background-color: #A2A2A2;
    border-radius: 5px;width: 60px; box-shadow: 2px 2px 0 0 rgba(0, 0, 0, 0.3);}
.ds-nav .ds-a:hover{background-color:#c3c6c7 !important;}
.ds-nav .ds-li.active .ds-a { background-color:#cccccc !important;}
...
.ds-a:hover, .ds-a:visited, .ds-a:link, .ds-a:active{text-decoration:none;}
.ds-nav{border:none;}
.ds-nav .ds-li{border:none;}
.ds-li.active .ds-a{background-color:#af96a8 !important;}
.ds-nav .ds-li .ds-a{position:relative;display:block;}
.ds-nav .ds-ul .ds-li{display:table-cell !important;width:1%;}
.ds-nav{border:none; background-color:#565758;}
.ds-nav .ds-a{color:#ffffff !important;font-size:12px;outline:none;border-radius: 0px;border-bottom: 1px solid #ffffff !important;}
.ds-nav .ds-a:hover{background-color:#af96a8 !important;}
.ds-nav .ds-li.active .ds-a {background-color:#af96a8 !important; padding-bottom:14px !important;border-bottom: 1px solid #ffffff !important;}
.hover{max-height:100px; max-width: 110px;}
...
/*
 ...
 .sides {
  ...
  .undoredo li:hover{
    background-color: rgba(255, 238, 246, .5);
  }
...
#div-clipartcategories a, #div-clipartsubcategories a {
  color: #565758;
  text-transform: uppercase;
...
.ds-modal .modal-header{padding: 0 15px !important;}
.ds-modal .close{color: #e63d90; font-size: 50px;}
...
.ds-entertext{width: 150px;height: 50px;margin-right: auto; margin-left: auto;}
.ds-btn-success{color:#fff;background-color:#E63D90;border-color:#ffffff;}
.ds-btn-success:hover{color:#fff;background-color:#A2A2A2;}
.ds-btn{border-radius:8px; padding: 15px;}
.save-design .ds-btn{padding:8px 20px;}
.btn-font {border: 0px solid #ffffff;}
.changefont-div{float: left;padding: 1px 10px;}
.changefont-div2{display: block; float: right;margin-left: 10px;padding: 1px 10px;}
.changefont-div3{display: none; float: right;margin-left: 10px;padding: 1px 10px;}
.edit-font-div{border: 1px solid #929090;}
...
.nav li{border:none;}
li.active a{}
.nav a{color:#ffffff !important;padding-top:1vh;padding-bottom:1vh;font-size:12;outline:none;padding:10px 1px;border: 0px solid transparent !important;}
...
#clipArtTable{width:100%;height:350px !important;overflow-x:hidden;}
#clipArtTable2{width:100%;height:350px !important;overflow-x:hidden;}
...
#fontmenu_body{overflow-y:auto;height:300px;overflow-x:hidden;}
.row{width:100%;}
...
.panel-heading, .panel-info,.input-group-addon, .breadcrumb{background-color:#fff !important;border:#717070 0px solid !important;color:#525252 !important; padding: 5px 5px;}
...
.breadcrumb{border-bottom:0px solid #9a9898 !important;}
...
.form-control2{border:1px solid #b7b7b7;border-radius:3px;display:block;height:2.3rem;margin-bottom:1.5rem;text-align:center;width:5rem;}
.sizeinput{border:0px solid #eeeeee;padding-bottom:5px;margin-bottom:20px;}
...
.progress { position:relative; width:100%; height: 30px; }
.bar { background-color: #E63D90; width:0%; height:30px; }
...
.transparent3:after{content:"";position:absolute;border-top:2px solid red;width:33px;transform:rotate(45deg);transform-origin:0% 0%;margin-left:4px;margin-top:3px;}
.transparent4:after{content:"";position:absolute;border-top:1px solid red;width:18px;transform:rotate(45deg);transform-origin:0% 0%;margin-left:3px;margin-top:2px;}
...
input[type="number"]::-webkit-outer-spin-button,
input[type="number"]::-webkit-inner-spin-button{appearance:none;margin:0;}
input[type=range]{-webkit-appearance:none;float:left;padding-top:5px;}
input[type=range]::-webkit-slider-runnable-track{height:5px;background:#eeeeee;border:none;border-radius:3px;}
input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;border:none;height:18px;width:18px;border-radius:50%;background:#31B0D5;margin-top:-6px;}
input[type=range]:focus{outline:none;}
input[type=range]:focus::-webkit-slider-runnable-track{background:#ccc;}
input[type=range]{border:1px solid white;float:left;padding-top:5px;}
input[type=range]::-moz-range-track{height:5px;background:#eeeeee;border:none;border-radius:3px;}
input[type=range]::-moz-range-thumb{border:none;height:18px;width:18px;border-radius:50%;background:#31B0D5;}
input[type=range]:-moz-focusring{outline:1px solid white;outline-offset:-1px;}
input[type=range]:focus::-moz-range-track{background:#ccc;}
input[type=range]::-ms-track{height:5px;float:left;background:transparent;border-color:transparent;border-width:6px 0;color:transparent;}
input[type=range]::-ms-fill-lower{background:#777;border-radius:1px;}
input[type=range]::-ms-fill-upper{background:#eeeeee;border-radius:3px;}
input[type=range]::-ms-thumb{border:none;height:18px;width:18px;border-radius:50%;background:#31B0D5;}
...
.block, .block-product, .block-clipart, .block-filltext, .block-stroketext, .block-textpersonalize, .block-numberpersonalize{
  float:left;
...
.animate:after, .animate2:after,.animate-product:after, .animate-clipart:after, .animate-filltext:after, .animate-stroketext:after,
.animate-numberpersonalize:after{content:url('../../img/icon/check.png');margin-left:7px;margin-top:3px;}

.animate, .animate2, .animate-product, .animate-clipart, .animate-filltext, .animate-stroketext,
.animate-numberpersonalize{border: 2px solid rgb(49, 176, 213) !important;}
    ...
    <div class="page"  id="app">
        <div class="ds-header">
            ...
            <div class="ds-cart-area">
                <div class="input-group" style="margin-right: 0px !important; padding-right: 0px !important; float: right !important;">
                    <span>
                        <button id="saveSectionLI" class="ds-btn ds-btn-success" onclick=" deselectAllCanvases(); ShowSaveShare();return false;">
                            <span class="glyphicon glyphicon-save">
                            </span> Save | Share
                        </button>
                        @if(Session::has('shoppingcart'))
                            <button id="directcheckout" class="ds-btn ds-btn-success" style="display: inline;" onclick="SaveDesignNameWindow('Check-out');">
                                <span class="glyphicon glyphicon-shopping-cart">
                                </span>Checkout
                            </button>
                        @else
                            <button id="directcheckout" class="ds-btn ds-btn-success" style="display: none;" onclick="SaveDesignNameWindow('Check-out');">
                                <span class="glyphicon glyphicon-shopping-cart">
                                </span>Checkout
                            </button>
                        @endif
                        <button id="getPriceBtn" class="ds-btn ds-btn-success" onclick=" ShowGetPrice();">
        ...
        <div class="ds-container">
            <div class="ds-menu" id="ds-menu">
                ...
                <li class="ds-li" onclick="document.getElementById('ds-work-area').style.display = 'block';deselectAllCanvases();">
                ...
                @guest
                    <li  class="ds-li" id="personalizeLI" onclick="displaypersonalize('backCanvas', true);">
                        <a class="ds-a" data-toggle="tab"  href="#personalizediv">
                        <img class="ds-img" id="personalize" src="{{asset('img/icon/personalize.png')}}" style="/*width:100%;*/">
                        <br>
                        <span class="ds-span">Add Name</span>
                        </a>
                    </li>
                @endguest
                @auth
                    @if(Auth::user()->type === 'Admin')
                        @foreach(Auth::user()->roles as $role)
                            ...
                            @elseif($role->name == 'Template Designer' || $role->name == 'Admin')
                                    <li  class="ds-li" id="saveTemplateLI">
                    ...
                    @elseif(Auth::user()->type === 'Customer')
                        ...
                        <li  class="ds-li" id="your_design" onclick="document.getElementById('ds-work-area').style.display = 'block';deselectAllCanvases();/* ShowYourDesign(); return false;*/">
            ...
            <div class="ds-work-area" id="ds-work-area">
                <div class="tab-content">
                    ...
                    <!-- START WELCOME TAB -->
                    <div id="defaultSection" class="tab-pane fade in active">
                        <div class="ds-panel-body ds-panel-div" style="height: 400px;">
                            <div>
                                <h1 class="product-titlenew3 pt-5" style="">Let's get started!</h1>
                                <p class="p-start">What would you like to do first?</p>
                            </div>
                            <div class="panel-body">
                            <div class="row pl-20" style="margin-bottom: 40px;">
                                <div class="col-xs-5 dsbutton ml-28">
                                    <center>
                            ...
                            <div class="row pl-20">
                                ...
                                <!--
                                <div class="col-xs-6 dsbutton">
                                        <center>
                                          <li class="ds-li" style="border: 2px solid #ffffff; border-radius: 10px; list-style-type: none;" onclick="startover();">
                                          <a data-toggle="tab" href="javascript:void(0)">Start Over</a>
                                    </li></center>
                                </div>
                               -->
                            </div>
                    ...
                    <div id="productSection" class="tab-pane fade">
                        <!-- START PRODUCTS INFO -->
                        <div class="row ds-panel-body ds-panel-div">
                                <!--START PRODUCT DESCRIPTION-->
                              <div class="col-xs-12">
                                <h5 class="product-titlenew" id="product_name">{{$product->parent->name}}</h5>
                                <div id="description_label">
                                    <p class="p-workarea"><strong>Brand:</strong> {{$product->brand}} </p>
                                    <p class="p-workarea"><strong>Sizes:</strong> YXS-5XL  <a href="javascript:void(0)" id="btnmodal" data-toggle="modal" data-target="#sizechartmodal"> |Size Chart</a></p>
                                    <p class="p-workarea"><strong>Fabric:</strong> {{$product->fabric}}</p>
                                    <p class="mb-20"><a href="#productlongdescription" data-toggle="collapse" id="more-details" class="collapsestart" onclick="moreless(this);">
                                        More Details</a></p>
                                </div>
                              </div>
                            <div id="productlongdescription" class="collapse col-xs-12">
                                {!!$product->description!!}
                            </div>
                        ...
                        <!-- END PRODUCTS INFO -->
                        <!-- START PRODUCTS COLOR -->
                        <div class="row ds-panel-body ds-panel-div">
                            <div class="col-xs-12 mt-15 mb-15">
                                <span class="product-colortitle">Current Product Color:</span> <span class="product-color uppercase" id="current_product_color"> : {{$product->color->name}}</span>
                            </div>
                            <div class="col-xs-12">
                                <div class="col-xs-12 color-div" style="width: 100%;" id="child_product_color_div"><strong>No Minimum</strong> (For Orders Quantity 1-5)<br>
                                    @foreach ($product->parent->colors as $color)
                                      @if($color->pivot->min_quantity == "1")
                                        <div id="child_color_minimum_{{$color->id}}" class="block-product color-{{$color->id}} {{$color->id == $product->color->id ? 'animate-product' : ''}}" title="{{$color->name}}" style="background-color: {{$color->hex}};" onclick="setcanvasproperties('{{$color->pivot->childproduct_id}}'); setactivecolor(this,'-product');"></div>
                                      @endif
                                    @endforeach
                                </div>
                                <div class="col-xs-12 color-div" style="width: 100%;" id="child_product_color_div6"><strong>6 Piece Minimum</strong> (For Orders Quantity 6+)<br>
                                    @foreach ($product->parent->colors as $color)
                                        <div id="child_color_minimum_{{$color->id}}" class="block-product color-{{$color->id}} {{$color->id == $product->color->id ? 'animate-product' : ''}}" title="{{$color->name}}" style="background-color: {{$color->hex}};" onclick="setcanvasproperties('{{$color->pivot->childproduct_id}}'); setactivecolor(this,'-product');"></div>
                                    @endforeach
                                </div>
                        ...
                        <!-- END PRODUCTS COLOR -->
                        <div class="col-xs-12">
                          <a type="button" class="ds-btn ds-btn-success ds-entertext form-control mt-15" style="display: block;" id="changeproductbtn" name="changeproductbtn" style="cursor: pointer;" onclick="showmodal('productmodal'); loadframe();">
                              <center>
                                  <span style="">Change Product</span>
                              </center>
                          </a>
                        </div>
                    </div>
                    ...
                    <!-- START ADDART SECTION -->
                    <div id="addArt" class="tab-pane fade">
                        <div id="newArt">
                            <clipartscomponent></clipartscomponent>
                            <!--UPLOAD SECTION-->
                            <div class="panel-group ds-panel-body ds-panel-div">
                                <div>
                                  <div class="panel-heading">
                                    <span class="product-titlenew2"><center>Upload your own Artwork</center></span>
                                  </div>
                                  <div class="row">
                                      <div class="col-xs-12">
                                          <div>
                                              <p class="pterms"><b>We accept the following file types:</b><br>
                                                  JPEG, JPG, GIF, PNG, BMP, GIF, TIF, AI, EPS, PDF, PSD, SVG</p>
                                          </div>
                                          <p class="pterms">Max Size: 10.0mb</p>
                                          <br>
                                  ...
                                  <div class="panel-body">
                                        ...
                                        <div class="row" id="uploaddiv" >
                                            <div class="col-xs-12" align="left"> <input type="file" id="file" name="file"  onchange="uploadImage();"/></div>
                                            ...
                                            <div class="col-xs-12" align="center"><button type="submit" id="upload" class="ds-btn-success" style="border-radius: 4px;padding: 8px 35px;display: none;">Upload</button>
                                            </div>
                                        </div>
                                        </form>
                        ...
                        <div id="editArt" style="display: none;" class="ds-panel-body mb-15">
                            <div>
                              <!--START SELECT ART COLOR TO EDIT SECTION-->
                              <div class="ds-panel-div" id="displaycolor">
                                <div class="row pt-5" >
                                    <div class="col-xs-12">
                                        <span id="ArtcolorText" name="ArtcolorText" style="display:inline; float;right;">Select a Color to edit: <span id="Artcolor" name="Artcolor" style="display:inline;color: #e63d90;"></span></span>
                                    </div>
                                    <div class="col-xs-12">
                                        <div id="objectcolors" name="objectcolors" style="float:left;"></div>
                                    </div>
                                </div>
                              </div>
                              <!--END SELECT ART COLOR TO EDIT SECTION-->
                              <!--START ART COLOR SWATCHES SECTION-->
                              <div class="ds-panel-div pt-5">
                                  <div id="Artcolorink" name="Artcolorink">
                                      ...
                                      <div id="inkcolorlist" class="pl-20">
                                          <div class="block-clipart transparent3" id="artcolortransparent" style="background-color: #ffffff; border:2px solid #eeeeee; cursor:pointer" onclick="document.getElementById('Artcolor').innerHTML = 'Transparent'; changecolor('transparent'); setactivecolor(this,'-clipart');">
                                          </div>
                                          @foreach($inkcolors as $inkcolor)
                                              <div id="artcolor{{$inkcolor->hex}}" class="block-clipart color-{{$inkcolor->id}}" title="{{$inkcolor->name}}" style="background-color: {{$inkcolor->hex}}; cursor:pointer" onclick="document.getElementById('Artcolor').innerHTML = '{{$inkcolor->name}}'; changecolor('{{$inkcolor->hex}}');setactivecolor(this,'-clipart'); ">
                                              </div>
                                          @endforeach
                                      </div>
                                      <br>
                                      <br>
                                      <div class="col-xs-12" style="margin-top: 15px; padding-left: 20px;" id="checkcolorlegend">
                                          <span class="block animate2"></span> <span class="p-workarea">Indicates a color already in your design</span>
                                      </div>
                                      <br>
                                      <div class="col-xs-12 col-xs-12 col-xs-12" style="padding-left: 20px;" id="artcolortransparentlegend">
                                          <div class="block transparent2">
                                          </div><span class="p-workarea">No Color/Transparent (</span>
                                      </div>
                                      <div class="row">
                                          <div class="col-xs-12">
                                              <div class="text-center">
                                                  <button class="ds-btn ds-btn-success" style="vertical-align:middle;padding: 8px 25px;" onclick="document.getElementById('editArt').style.display = 'block';  document.getElementById('newArt').style.display = 'none'; document.getElementById('changecolorArt').style.display = 'none'; deselectAllCanvases();"><span>Done</span></button>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                              <!--END ART COLOR SWATCHES SECTION-->
                            <div class="ds-panel-body ds-panel-div" id="displaynoeditcolor">
                                    <div class="row" style="">
                                        <div class="col-xs-12">
                                            <div id="objectcolors3" name="objectcolors3" style=""></div>
                                        </div>
                                    </div>
                            ...
                            <div class="ds-panel-body ds-panel-div" id="displayfullcolor" style="display:none">
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <span  style="">FULL COLOR IMAGE</span>
                                            </div>
                                        </div>
                                        <div class="panel-body">
                                            <span><b>COLOR EDIT:</b> NOT AVAILABLE FOR THIS IMAGE </span>
                                ...
                                <div class="ds-panel-body ds-panel-div">
                                    <div class="panel-body">
                                      <span class="product-color">Edit Art Size</span>
                                        ...
                                        <div style="">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-2 inputslider" align="right"><input id="widthvalueImage" type="text" onkeypress="validate(event);" name="widthvalueImage" min="1" max="12" oninput="resize(event);" step="0.1" style="width: 50px !important; font-size: 11px;" ></div>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="mb-15">
                                            <div class="col-xs-12 mb-15">
                                                ...
                                                <div class="col-xs-8  inputslider"> <input id="heightImage" type="range" min="1" max="16" name="heightImage" oninput="resize(event);"  step="0.1"> </div>
                                                <div class="col-xs-2 inputslider" align="right"><input id="heightvalueImage" type="text" onkeypress="validate(event);" name="heightvalueImage" min="1" max="12" oninput="resize(event);" step="0.1" style="width: 50px !important; font-size: 11px;" ></div>
                                            </div>
                                        </div>
                                        <br>
                                        <div>
                                            <div class="col-xs-12 mb-15">
                                                <div class="col-xs-2 inputslider" align="left"> <span>Rotate</span> </div>
                                                ...
                                                <div class="col-xs-2 inputslider" align="right"><input id="anglevalueImage" type="number" onkeypress="validate(event);" name="anglevalueImage" min="-180" max="180" value="0" oninput="rotate(event);" step="5" style="width: 50px !important; font-size: 11px;" ></div>
                                            </div>
                                        </div>
                                        <br>
                                        <!-- Start New Rotation Section -->
                                        <div class="col-xs-12" style="padding-left: 1px; padding-right: 1px; margin-left:auto; margin-right:auto;margin-top: 10px;">
                                            <div class="col-xs-4" style="background-color: #eeeeee; padding: 1px; border-right: solid 4px white;">
                                                <div class="col-xs-6" align="center" style="padding: 1px; border-right: solid 1px black;"><span onclick="flipX();" style="cursor: pointer;"><img src="{{asset('img/icon/icon-flip-across.png')}}" width="22px" height="auto"></span></div>
                                                <div class="col-xs-6" align="center" style="padding: 1px;"><span onclick="flipY();" style="cursor: pointer;"><img src="{{asset('img/icon/icon-flip-up.png')}}" width="auto" height="20px"></span></div>
                                            </div>
                                            <div class="col-xs-5" style="background-color: #eeeeee; padding: 1px; border-right: solid 4px white;">
                                                <div class="col-xs-6" align="center" style="padding: 1px; border-right: solid 1px black;" onclick="SetLayer('forward');"><span style="cursor: pointer;"><img src="{{asset('img/icon/icon-layer-up.png')}}" width="auto" height="20px"></span></div>
                                                <div class="col-xs-6 col-" align="center" style="padding: 1px;" onclick="SetLayer('backward');"><span style="cursor: pointer;"><img src="{{asset('img/icon/icon-layer-down.png')}}" width="auto" height="20px"></span></div>
                                            </div>
                                            <div class="col-xs-3" style="background-color: #eeeeee; padding: 1px;">
                                        ...
                                        <div class="col-xs-12" style="padding-left: 1px; padding-right: 1px;">
                                            ...
                                            <div class="col-xs-5" align="center"><span>Layers order</span></div>
                                            <div class="col-xs-3" align="center"><span>Center</span></div>
                                        </div><br>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center">
                                            <button class="ds-btn ds-btn-success" style="vertical-align:middle;padding: 8px 25px;" onclick="document.getElementById('editArt').style.display = 'none';  document.getElementById('newArt').style.display = 'block'; deselectAllCanvases();"><span>Back to category</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="addTemplate" class="tab-pane fade">
                        <div class="panel-group">
                            <div>
                                <div class="panel-body">
                    ...
                    <div id="textSection" class="tab-pane fade">
                        <div id="new_text">
                            <div>
                                <div class="form-group mb-40 mt-15" style="">
                                    <label for="comment"><span class="uppercase">Enter text:</span></label>
                                    <textarea class="form-control" rows="3" id="textarea"></textarea>
                                    <br>
                                    <button type="button" id="textareabtn" class="ds-btn ds-btn-success ds-entertext form-control" style="display:block !important;" onclick="addtext();/*OpenClose('carousel_area','work_area','textareabtn');*/">Add Text</button>
                                </div>
                                <div class="mb-15">
                                    <div class="edit-font-div" id="fontbtn" style="display: none;">
                                        <div class="panel-heading">
                                            <button class="btn-font btn-block" data-toggle="collapse" href="#fontpanel" onclick="fontMenu();" style="background-color: #ffffff;padding: 6px 0px;">
                                                <span class="uppercase changefont-div" id="font_title" style=""> Change fonts</span>
                                                <span id="up" class="glyphicon glyphicon-chevron-down changefont-div2" style=""></span>
                                                <span id="down" class="glyphicon glyphicon-chevron-up changefont-div3" style=""></span>
                                                <span class="uppercase" id="font_preview" style="float: right;">Old standard </span>
                                            </button>
                                        </div>
                                        <div id="fontpanel" class="panel-collapse collapse">
                                            <div class="panel-body ds-panel-body">
                            ...
                            <div id="textmenu" style="display: none;">
                                ...
                                <div class="ds-panel-div">
                                    <div class="ds-panel-body" >
                                        <div class="panel-heading"><span class="uppercase">Text Color: </span><label id="Textcolor" name="Textcolor"></label></div>
                                        <div>
                                            <div class="col-xs-12 mt-15" style="padding-left: 20px;" id="checkcolorlegend"><span class=" block animate2"></span>
                                            <span class="p-workarea">Indicates a color already in your design</span>
                                            </div>
                                            <div>
                                                <div class="col-xs-12 mt-15" style="">
                                                    @foreach($inkcolors as $inkcolor)
                                                        <div id="textcolor{{$inkcolor->hex}}" class="block-filltext" title="{{$inkcolor->name}}" style="background-color:{{$inkcolor->hex}}; cursor:pointer" onclick="/*OpenClose('carousel_area','work_area','Textcolor');*/ document.getElementById('Textcolor').innerHTML = '{{$inkcolor->name}}';changecolorText('{{$inkcolor->hex}}','f');setactivecolor(this,'-filltext');">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
                                            ...
                                            <div id="Outlinediv" style="display: none;">
                                                ...
                                                <h5><span>Text Stroke Color: </span><label id="Textstrokecolor" name="Textstrokecolor"></label></h5>

                                                <div>
                                                        <div>
                                                            <div class="col-xs-12" style="margin-top:10px;">
                                                                @foreach($inkcolors as $inkcolor)
                                                                    <div id="strokecolor{{$inkcolor->hex}}" class="block-stroketext" title="{{$inkcolor->name}}" style="background-color:{{$inkcolor->hex}}; cursor:pointer" onclick="/*OpenClose('carousel_area','work_area','Textstrokecolor');*/ document.getElementById('Textstrokecolor').innerHTML = '{{$inkcolor->name}}';changecolorText('{{$inkcolor->hex}}','c');setactivecolor(this,'-stroketext');">
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="input-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xs-2 col-xs-2 col-xs-2 col-xl-2"><input min="0" max="10" value="0" id="strokewidthvalue" type="text" onkeypress="validate(event);" name="strokewidthvalue" step="1" style="width: 50px !important; font-size: 11px; float: left;" oninput="setStroke(this);" readonly></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <!--End Text Color Section -->
                                <!-- Start Text Size Area  -->
                                <div class="ds-panel-div">
                                <div class="ds-panel-body">
                                    <div class="panel-body">
                                      <center><i class="fa fa-lock" id="resizeicontext" style="font-size:25px;color:#31b0d5; cursor: pointer;" onclick="SetScaleProportional('text');"></i></center>
                                        <div>
                                          <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-2 inputslider" align="right"><input id="widthvalueText" type="text" onkeypress="validate(event);" name="widthvalueText" min="1" max="12" oninput="resize(event);" step="0.1" style="width: 50px !important; font-size: 11px;" ></div>
                                          </div>
                                        </div>
                                        <br>
                                        <div class="mb-15">
                                          <div class="col-xs-12 mb-15">
                                                ...
                                                <div class="col-xs-2 inputslider" align="right"><input id="heightvalueText" type="text" onkeypress="validate(event);" name="heightvalueText" min="1" max="12" oninput="resize(event);" step="0.1" style="width: 50px !important; font-size: 11px;" ></div>
                                              </div>
                                        </div>
                                        <br>
                                    </div>
                                    <div class="panel-body">
                                      <div class="col-xs-12 mb-15">
                                            ...
                                            <div class="col-xs-2 inputslider" align="right"><input id="anglevalueText" type="number" onkeypress="validate(event);" name="anglevalueText" min="-180" max="180" value="0" oninput="rotate(event);" step="5" style="width: 50px !important; font-size: 11px;" ></div>
                                          </div>
                                    </div>
                                </div>
                                <!-- End Text Size Area  -->
                                <!-- START Flip Text Area   -->
                                <div class="ds-panel-body">
                                    <div class="panel-body">
                                        ...
                                        <div id="texteffecsarea" style="display: none;">
                                            <div>
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="col-xs-2 inputslider" align="right"><input class="hidden-md" id="sizeTextvalue" type="text" onkeypress="validate(event);" name="sizeTextvalue" min="10" max="50" value="50" oninput="resize(event);" style="width: 50px !important; font-size: 11px;"></div>
                                                </div>
                                            </div>
                                            <br>
                                            <div>
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="col-xs-2 inputslider" align="right"><input min="-360" max="360" value="90" id="radiusvalue" type="text" onkeypress="validate(event);" name="radiusvalue" step="1" style="width: 50px !important; font-size: 11px;"></div>
                                                </div>
                                            </div>
                                            <br>
                                            <div>
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="col-xs-2 col-xs-2 col-xs-2 col-xs-2 inputslider" align="right"><input min="1" max="40" value="5" id="spacingvalue" type="text" onkeypress="validate(event);" name="spacingvalue" step="1" style="width: 50px !important; font-size: 11px;"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div id="personalizediv" class="tab-pane fade">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <div id="textpersonalizecolor" name="textpersonalizecolor" class="block-textpersonalize" title="Black" style="border-radius:  50%; margin-right: 1.7px; background-color: #000000; width: 30px; height: 30px; border:1px solid #eeeeee; cursor:pointer" disabled onclick="setcolorpersonalize(this);"></div><span id="textpersonalizecolorname" name="textpersonalizecolorname" disabled >Black</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <div id="numberpersonalizecolor" name="numberpersonalizecolor" class="block-numberpersonalize" title="Black" style="border-radius:  50%; margin-right: 1.7px; background-color: #000000; width: 30px; height: 30px; border:1px solid #eeeeee; cursor:pointer" disabled onclick="setcolorpersonalize(this);"></div><span id="numberpersonalizecolorname" name="numberpersonalizecolorname" disabled >Black</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <div id="textpersonalizestrokecolor" name="textpersonalizestrokecolor" class="block-textpersonalize" title="Black" style="border-radius:  50%; margin-right: 1.7px; background-color: #000000; width: 30px; height: 30px; border:1px solid #eeeeee; cursor:pointer" disabled onclick="setcolorpersonalize(this);"></div><span id="textpersonalizestrokecolorname" name="textpersonalizestrokecolorname" disabled >Black</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-xs-4">
                                                <div class="checkbox">
                                                    <label>
                                                        <div id="numberpersonalizestrokecolor" name="numberpersonalizestrokecolor" class="block-numberpersonalize" title="Black" style="border-radius:  50%; margin-right: 1.7px; background-color: #000000; width: 30px; height: 30px; border:1px solid #eeeeee; cursor:pointer" disabled onclick="setcolorpersonalize(this);"></div><span id="numberpersonalizestrokecolorname" name="numberpersonalizestrokecolorname" disabled >Black</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="ds-design-area col-xs-7" id="ds-design-area">
                <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                    ...
                    <li name="undo" id="undo" style="border: 0px solid #696973;">
                        <span class="glyphicon glyphicon-share-alt fa-flip-horizontal ds-rvpadding"></span>
                        <br>
                        <span class="ds-right-font">Undo</span>
                    </li>
                    <li name="redo" id="redo" style="border: 0px solid #696973;">
                        <span class="glyphicon glyphicon-share-alt ds-rvpadding"></span>
                        <br>
                        <span class="ds-right-font">Redo</span>
                    </li>
                    <li  name="zoomin" id="zoomin" style="border: 0px solid #696973;">
                        <span class="glyphicon glyphicon-zoom-in ds-rvpadding"></span>
                        <br>
                        <span class="ds-right-font">Zoom In</span>
                    </li>
                    <li  name="zoomout" id="zoomout" style="border: 0px solid #696973;">
                        <span class="glyphicon glyphicon-zoom-out ds-rvpadding"></span>
                        <br>
                        <span class="ds-right-font">Zoom Out</span>
                    </li>
                    <li  name="clone" id="clone" style="border: 0px solid #696973;" onclick="copyclipart();">
                       <span class="glyphicon glyphicon-plus ds-rvpadding"></span>
                        <br>
                        <span class="ds-right-font" style="font-size: 9px !important;">Copy Layer</span>
                    </li>
                </ol>
...
<!-- Footer Start -->
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                            ...
                            <div class="panel-body">
                                ...
                                <div id="demo" class="collapse">
                                    <div class="panel panel-default">
                                        ...
                                        <center>
                                            <button type="button" class="btn btn-primary" id="category_insert_btn" name="category_insert_btn" onclick="saveCategory();">Add New Product Category</button>
                                        </center>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <button id="savetemplatebtn" type="button" class="btn btn-default" onclick="savetemplate();">Save</button>
                        <button id="overridetemplatebtn" type="button" class="btn btn-default" onclick="overridetemplate();">Save</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="productmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" style="max-width: 1400px;  width: 100%;height: auto; margin: auto;padding: 0;">
                <div class="modal-content" style="width: 100%; height: auto; margin: 0; padding: 0;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -15px;margin-bottom: -15px;"><span aria-hidden="true" style="font-size: 60px; color: #E63D90;">&times;</span></button>
                        <h4 class="modal-title"><span class="uppercase">Products</span></h4>
                    </div>
                    <div class="modal-body" style="width: 100%; height: 80vh;">
                        <products></products>
                        <!--<productlist></productlist>
                        <div id="loaderframe" class="loader" style="display: block; z-index:1;">
                        </div>
                        <iframe src="" style="width: 100%; height: 100%; position: absolute; z-index:2;" id="productlist" ></iframe>-->
                    </div>
                </div>
        ...
        <div id="signupModal" class="modal fade " role="dialog">
                    ...
                    <div class="modal-content" style="text-align: center;">
                        ...
                        <div class="modal-body" style="background-color: #eeeeee;">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-xs-10">
                                                <input type="email" class="form-control" id="user_name" placeholder="Enter Email" name="user_name"><br>
                                            </div>
                            ...
                            <div id="panelregister" style="display: none;">
                                ...
                                <div class="panel-body">
                                    <form id="register-form" method="post" onsubmit="return register()" role="form" style="display: block;" class="form-horizontal">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-xs-10" align="left">
                                                ...
                                                <a href="#passwordrules" data-toggle="collapse">Specifications</a>
         ...
         <div class="modal fade" id="sizechartmodal" role="dialog">
            <div class="modal-dialog modal-lg">
                ...
                <div class="modal-body">
                    <div class="row">
                      <h5 class="product-titlenew" id="product_name">{{$product->parent->name}}</h5><p><strong>Brand:</strong> {{$product->brand}} </p>
        ...
        <div id="signupchecoutModal" class="modal fade " role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="text-align: center;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h5 class="modal-title uppercase">Sign in for faster checkout.</h5>
                    </div>
                    <div class="modal-body" style="background-color: #eeeeee;">
                        <form id="login-beforecheckout-form" method="post" onsubmit="return loginbeforecheckout()" role="form" style="display: block;">
                            <div  id="panellogin">
                                <div class="panel-heading"> <span class="uppercase">RETURNING CUSTOMER </span></div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-xs-2" for="emailc" style="text-align: left;">Email:</label>
                                        <div class="col-xs-12 col-xs-10">
                                            <input type="username" class="form-control" id="emailc" placeholder="Enter Email" name="emailc"><br>
                                        </div>
                                        <!--<small id="passwordHelp" class="form-text text-muted" data-toggle="tooltip" data-placement="top" title="Passwords must be at least 8 characters in length include (lower case letters, upper case letters, number and special characters).">Make sure password meets specifications.</small>-->
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-xs-12 col-xs-2" for="pass_wordc" style="text-align: left;">Password:</label>
                                        <div class="col-xs-12 col-xs-10">
                                            <input type="password" class="form-control" id="pass_wordc" placeholder="Enter Password" name="pass_wordc"><br>
                                        </div>
                                    </div>
                                    <div class="form-group">

                                        <button type="button" class="btn btn-block" onclick="loginbeforecheckout();" style="cursor: pointer; text-transform: uppercase; text-decoration: none;font-size: 1em;background-color: #c00;border-color: #c00;color: #fff;font-weight: 500;padding: 10px;width: 100%;text-align: center;">Sign In</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <div>
                            <div class="panel-heading"> <span class="uppercase">NEW CUSTOMERS </span></div>
                            <div class="panel-body">
                              <a  href="{{asset('shopping-cart')}}" class="btn btn-block" style="cursor: pointer; text-transform: uppercase; text-decoration: none;font-size: 1em;background-color: #c00;border-color: #c00;color: #fff;font-weight: 500;padding: 10px;width: 100%;text-align: center;">Continue as Guest</a>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <div class="modal fade ds-modal" id="SaveShareModal" role="dialog" style="overflow-y: auto;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body" style="overflow-y: hidden">
                        ...
                        <!--START SAVE & SHARE SECTION-->
                        <div class="row save-design" id="SaveShareModalDiv">
                            <div class="mb-20">
                            ...
                            <!--START SAVE SECTION-->
                            <div class="mb-20">
                                <div class="row save-design">
                                   <div class="col-xs-12">
                                      <div class="panel-heading mb-10"><center><span class="uppercase">Save Your Design</span></center></div>
                                      <center><button type="button" name="submit" class="ds-btn ds-btn-success" onclick="SaveDesignNameWindow('save');" style="">
                                         Save
                                      </button></center>
                            ...
                            <!--START SHARE SECTION-->
                            <div id="share_div" name="share_div">
                                <div class="col-xs-12">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" id="emailform">
                                        <div class="row save-design">
                                            ...
                                            <div class="col-xs-6" style="padding-right: 0px">
                                                <div class="input-group">
                                                    ...
                                                    <input id="to_email" type="text" class="form-control" name="to_email" placeholder="text@sample.com,text2@sample.com" required>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <br>
                                        <center>
                                            <button type="button" name="submit" class="ds-btn ds-btn-success" onclick="SaveDesignNameWindow('saveasguest');" style="">
                                              Send Email
                                            </button>
                                        </center>
                                    </form>
     ...
     <div class="modal fade" id="sizechartmodal" role="dialog">
        ...
        <div class="modal fade" id="personalizeconfirmation-modal" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" id="modal-btn-personalize-yes">Continue</button>
                        <button type="button" class="btn btn-primary" id="modal-btn-personalize-no">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
        <!-- START BUY | GET PRICE SECTION -->
        <div class="modal fade ds-modal" id="productPicker" role="dialog">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="product_style_area" style="display: block;">
                            <div class="row mb-40">
                                <div class="col-xs-7 col-xs-7 text-center" style="">
                                    <div class="row" id="getpriceDesign">

                                    </div>
                                </div>
                                <!-- START ENTER QUANTITY SECTION -->
                                <div class="col-xs-5 col-xs-5 visible-lg visible-md">
                                  <span>
                                  ...
                                  <div class="productsizes2">
                                      ...
                                      <div class="row productsizeseow2">
                                          <!-- START YOUTH SIZE SECTION -->

                                          <div id="youth" class="col-xs-12 sizeinput" style="display: block;">
                                            <h5 class="sizediv-font">Youth</h5>
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_YXS">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_YS">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_YM">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_YL">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_YXL">
                                          ...
                                          <!-- START ADULT SIZE SECTION -->
                                          <div id="adult" class="col-xs-12 sizeinput" style="display: none;/* float: right;*/">
                                            <h5 class="sizediv-font">Adult</h5>
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_XS">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_S">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_M">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_L">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_XL">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_2XL">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_3XL">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_4XL">
                                              ...
                                              <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem; text-align: center;" id="div_5XL">
                                          ...
                                          <!-- START ONE SIZE FITS ALL SECTION -->
                                          <div class="row productsizeseow2">
                                              <div id="onesize" class="col-xs-12 sizeinput" style="display: none;/* float: right;*/">

                                                  <div style="display:none; -webkit-box-flex: 0;flex: 0 0 2.25rem; margin-right: .25rem;" id="div_ONE_SIZE">
                                                  ...
                                                  <h5 class="sizediv-font">ONE SIZE</h5>
                                              </div>
                                          </div>
                            ...
                            <div class="row">
                                <span style="color: #000; font-size: 24px; font-weight: 700;">
                                    <center>Your All Inclusive Pricing 1</center>
                                </span>
                                <div>
                                  <div class="col-xs-6">
                                    <h4 id="itemPriceLabel" style="margin-top: 2px;"><b>Price:</b> <span id="itemPrice" style="color: #5cb85c; font-family: Arial;"></span> (each)</h4>
                                  ...
                                  <div class="col-xs-6 visible-lg visible-md" style="border-left: 1px solid #6d6f71;">
                        ...
                        <div class="row middlePage" id="cart_area" style="padding-top: 50px;" style="display: block;">
        ...
        <div class="modal fade" id="save-edit-design" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" style="color:red">Override Design?</h4>
                    </div>
                    <div class="modal-body">
                        <p>Your design will be override</p>
                        <p>Are you sure want to override the current design </p>
                        <p></p>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-block" onclick="closemodal('save-edit-design'); this.override =true;saveDesign('overridedesign');">Yes</button>
                        <button type="button" class="btn btn-success btn-block" onclick="closemodal('save-edit-design');">No</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="save-edit-template" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" style="color:red">Override Template?</h4>
                    </div>
                    <div class="modal-body">
                        <p>Your template will be override</p>
                        <p>Are you sure want to override the current template </p>
                        <p></p>

                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-block" onclick="closemodal('save-edit-template'); document.getElementById('loaderMain').style.display = 'block'; overridetemplate();">Yes</button>
                        <button type="button" class="btn btn-success btn-block" onclick="closemodal('save-edit-template');">No</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        var user = null;
        var scale = 0.25;
        var textAdded = clipArtAdded = imageUploaded = colorChanged = addingToCart = resized = Checked = productchanged = saveOnly = override = false;
        ...
        var currentdesign = null;//  {arrayside :[], name:'',product:null, type:"Designstudio", num_shirts:0, price_per_shirt:0, total:0};
          ...
          displayShippingDate();
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    {
                        if(parameter.type == 'e' || parameter.type == 't'  || parameter.type == 'a' || parameter.type == 'at'   || parameter.type == 'r')
                        {
        ...
        function setcanvasproperties(id)
        {
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    var description_label = '<p class="p-workarea"><strong>Brand:</strong> ' + data.product.brand + ' </p>';
                    description_label += '<p class="p-workarea"><strong>Size:</strong> ' + data.product.parent.sizes[0].name  + '-' + data.product.parent.sizes[data.product.parent.sizes.length -1].name + '  <a href="javascript:void(0)" data-toggle="modal" data-target="#sizechartmodal"> size chart</a></p>';
                    description_label += '<p class="p-workarea"><strong>Fabric:</strong> ' + data.product.fabric + '</p>';
                    description_label += '<p class="mb-20"><a href="#productlongdescription" data-toggle="collapse" id="more-details" class="collapsestart" onclick="moreless(this);"> More Details </a></p>';
        ...
        */
        ...
        function loadchangeproduct(showproduct)
        {
            ...
            var description_label = '<p class="p-workarea"><strong>Brand:</strong> ' + product.brand + ' </p>';
            description_label += '<p class="p-workarea"><strong>Size:</strong> ' + product.parent.sizes[0].name  + '-' + product.parent.sizes[product.parent.sizes.length -1].name + '  <a href="javascript:void(0)" data-toggle="modal" data-target="#sizechartmodal"> size chart</a></p>';
            description_label += '<p class="p-workarea"><strong>Fabric:</strong> ' + product.fabric + '</p>';
            description_label += '<p class="mb-20"><a href="#productlongdescription" data-toggle="collapse" id="more-details" class="collapsestart" onclick="moreless(this);"> More Details </a></p>';
            document.getElementById("description_label").innerHTML = description_label;
            document.getElementById("productlongdescription").innerHTML = product.parent.description;
            var sidesinfo = "";
            var innersinfo = "";
            var countsides = 0;
            var countinners = 0;
            ...
            if(product.parent.colors.length > 0)
            {
                ...
                product.parent.colors.forEach(color => {
                    ...
                    if(color.hex != null)
                    {
                      if(color.pivot.min_quantity == 1)
                      {
                        colorminimum += '<div id="child_color_minimum_' + color.id + '" title="' + color.name +'" onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" class="block-product ' + animate + '" style="border-radius: 50%; background-color: ' + color.hex + '; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;"></div>';
                      }
                      colorminimum6 += '<div id="child_color_minimum_' + color.id + '" title="'+ color.name +'" onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" class="block-product ' + animate + '" style="border-radius: 50%; background-color: ' + color.hex + '; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;"></div>';
                    }
                    else
                    {
                      if(color.pivot.min_quantity == 1)
                      {
                        colorminimum += '<img onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" src="' + window.location.origin + '/img/color/' + color.file + '" id="child_color_minimum_' + color.id + '" class="block-product ' + animate + '" style="width: 30px; position: relative; height: 30px; border: 0px solid rgb(238, 238, 238); border-radius: 50%; cursor: pointer;">';
                      }
                      colorminimum6 += '<img onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" src="' + window.location.origin + '/img/color/' + color.file + '" id="child_color_minimum_' + color.id + '" class="block-product ' + animate + '" style="width: 30px; position: relative; height: 30px; border: 0px solid rgb(238, 238, 238); border-radius: 50%; cursor: pointer;">';
                    }
                });

                if (colorminimum !== "")
                {
                  document.getElementById("child_product_color_div").innerHTML = " <strong>No Minimum</strong> (For Orders Quantity 1-5)<br>" + colorminimum ;
                  document.getElementById("child_product_color_div").style.display = "block";
                }
                else
                {
                  document.getElementById("child_product_color_div").innerHTML = "";
                  document.getElementById("child_product_color_div").style.display = "none";
                }

                if (colorminimum6 !== "")
                {
                  document.getElementById("child_product_color_div6").innerHTML = " <strong>6 Piece Minimum</strong> (For Orders Quantity 6+)<br>" + colorminimum6 ;
                  document.getElementById("child_product_color_div6").style.display = "block";
                }
                else
                {
                  document.getElementById("child_product_color_div6").innerHTML = "";
                  document.getElementById("child_product_color_div6").style.display = "none";
                }
            }
        ...
        * @return void
        */
        function setactivecolor(element, type)
        {
            var circlescolors = document.getElementsByClassName("block"+ type);
            var i;
            for (i = 0; i < circlescolors.length; i++)
            {
                if(circlescolors[i] == element)
                    element.className = "block"+ type + " animate"+ type;
                else
                    circlescolors[i].className = "block"+ type;
            }
        }
        ...
        */
        function displayinfo(e)
        {
            ...
            {
                if(modifiedObject.id != 'textpersonalizeback' && modifiedObject.id != 'textpersonalizefront' && modifiedObject.id != 'numberpersonalizeback' && modifiedObject.id != 'numberpersonalizefront')
                {
        ...
        */
        ...
        function SaveDesignNameWindow(value)
        {
            switch (value)
            {
                case 'savetemplate':
                    ...
                    if (num > 0)
                    {
                        if(parameter.type == 'at')
                        {
                            document.getElementById('savetemplatebtn').style.display = 'none';
                            document.getElementById('category_insert_btn').style.display = "none";
                            document.getElementById('overridetemplatebtn').style.display = 'block';
                            document.getElementById("oldcategory[]").value = designinfo.category_id + '_' + designinfo.subcategory_id;
                            document.getElementById("oldcategory[]").disabled = true;
                        }
                        else
                        {
                            document.getElementById('savetemplatebtn').style.display = 'block';
                            document.getElementById('category_insert_btn').style.display = "block";
                            document.getElementById('overridetemplatebtn').style.display = 'none';
                            document.getElementById("oldcategory[]").disabled = false;
                        }
                        //showmodal('save-edit-template');
                ...
                case 'Check-out':
                    if(user != null)
                    {
                      if (user.id != null)
                      {
                          Checkout();//put code for go to new page login or guest before checkout
                      }else{
                        $('#productPicker').modal("hide");
                        $('#signupchecoutModal').modal("show");
                      }
                    }
                    else
                    {
        ...
        function buildcart(body)
        {
            ...
            for (var i = 0; i < shoppingcart.items.length; i++)
            {
                ...
                var imgName = shoppingcart.items[i].sides[0].img;
        ...
        {
            setColorsInk();
            if ( textAdded || clipArtAdded || imageUploaded || colorChanged || addingToCart || resized || Checked || productchanged || saveOnly || override)
            {
                if (from == "saveOnly")
                {
                ...
                canvaslist.forEach(canvas=>{
                    ...
                    if(canvas.getObjects().length > 0)
                    {
                        ...
                        saveddesign.personalizetype = currentdesign.personalizetype,
                        saveddesign.personalizelist= currentdesign.personalizelist,
                ...
                if (from == "saveOnly")
                {
                   ...
                   $.ajax({
                        ...
                        success:function(data)
                        {
                            ...
                            textAdded = clipArtAdded = imageUploaded = colorChanged = addingToCart = resized = Checked = productchanged = saveOnly = override = false;
                        },
                        error: function(error)
                        {
                ...
                else if (from == "overridedesign")
                {
                   $.ajax({
                        ...
                        url: window.location.origin + '/overridedesign',
                        success:function(data)
                        {
                            //currentdesign.id = data.design.id;
                            document.getElementById("loaderMain").style.display = "none";
                        ...
                        error: function(error)
                        {
                            console.log("error in method saveDesign('overridedesign'):");
                            console.log(error);
                        }
                    });
                }
                else if (from == "saveasguest")
                {
                    ...
                    $.ajax({
                        ...
                        {
                            if (response['design']) {
                                currentdesign.id = response.design.id;
                            }
                            ...
                            document.getElementById("loaderEmail").style.display = "none";
                            showalert('designsaved', 'Email Sent!', 'success', 'Send Email');
                        },
                        error: function(error)
                        {
                            setTimeout(() => {
                            ...
                            document.getElementById("loaderEmail").style.display = "none";
                            showalert('designfailedtobesaved', 'Failed to send email, please try again!', 'danger', 'Send Email');
                        }
                    });
            ...
            else
            {
                ...
                {
                    showalert('savealert', 'No change to save!', 'danger', 'Save');
                }
                else if (from == "AddKeepDesign")
                {
                    showalert('savealert', 'No design to save!', 'danger', 'Save');
        ...
        function loginbeforecheckout()
        {
            ...
            var password = $("input[name=pass_wordc]").val();
            var data = {
                _token:token,
                email:email,
                password:password
        ...
        function register()
        {
            ...
            $.ajax({
                ...
                error: function (data)
                {
                    console.log('Fail to run Register..');
                    console.log(data);
                }
            });
            return false;
        ...
        */
        ...
        function savetemplate()
        {
            ...
            $.ajax({
                ...
                url: window.location.origin + '/saveastemplate',
                success:function(data)
                {
                ...
                error: function(error) {
                    showalert('designsavederror', 'Error Saving Design!', 'danger', 'Saved Design Error');
                    document.getElementById("loaderMain").style.display = "none";
                    console.log(error);
                }
            });
        ...
        function overridetemplate()
        {
            ...
            $.ajax({
                ...
                url: window.location.origin + '/overridetemplate',
                success:function(data)
                {
                    closemodal('saveTemplateModal');
                    document.getElementById("loaderMain").style.display = "none";
        ...
        function displaypersonalize(side, set)
        {
            ...
            else
            {
                ...
                if(product.ispersonalize == 1 && num > 0)
                {
                    $("#personalizeconfirmation-modal").modal('show');
                }
            }
        }
        ...
        {
            if(product.ispersonalize == 0)
            {
                showalert('personalizenotallowed', 'This product dont allow a personalize functions!', 'danger', 'Personalize product error');
                $('.nav-tabs a[href="#productSection"]').tab('show');
            }
            else
            {
        ...
        function SavePersonalizeList(save)
        {
            ...
            for (var i = 0; i < list.length-1; i+=step)
            {
                ...
                {
                    var personalize = {name:"", number:"", size_name:"", price:0.0};
                    if (document.getElementById("textpersonalizecheck").checked && document.getElementById("numberpersonalizecheck").checked)
                    {
                        if (list[i].value != "")
                        {
        ...
        $("#modal-btn-personalize-yes").on("click", function()
        {
            canvasdesignlist = [];
            canvaslist.forEach(canvas => {
                canvas.clear();
            });
            $("#personalizeconfirmation-modal").modal('hide');
        });

        $("#modal-btn-personalize-no").on("click", function()
        {
            $("#personalizeconfirmation-modal").modal('hide');
        });

        function setselectedproduct(childproductid,colorid,colorname)
        {
            iframe = document.getElementById('productlist');
            let taketostudio = iframe.contentWindow.document.getElementById('go_designstudio');
        ...
        $(document).ready(function () {
         ...
         function loadframe()
         {
            //document.getElementById('productlist').src='';
            //document.getElementById('productlist').src=window.location.origin + '/product-list-studio';
            document.getElementById('listproduct').style.display = 'block';
            document.getElementById('singleproduct').style.display = 'none';
         }
