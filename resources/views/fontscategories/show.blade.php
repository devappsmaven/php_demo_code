...
@section('title','Font Categories Details')
@section('pagename','Font Categories Details')
@section('menuname','Font Categories Details')
@section('content')
  ...
  <div class="col-md-4">
    ...
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-header bg-aqua-active">
        <h3 class="widget-user-username">{{$fontcategory->name}}</h3>
      </div>
        ...
        <div class="row">
          <div class="col-sm-4 border-right">
            <div class="description-block">
              ...
              <span class="description-text">{{$fontcategory->description}}</span>
          ...
          <div class="col-sm-4">
            <div class="description-block">
              ...
              <span class="description-text">{{$fontcategory->status}}</span>
            </div><!-- /.description-block -->
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  @can('fontscategories.index')
                    <a type="button" class="btn btn-info" href="{{route('fontscategories.index')}}" >Back to List</a>
                  @endcan
                </div>
              </div>
            </div>
