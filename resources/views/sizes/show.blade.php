...
@section('pagename','Sizes Details')
@section('menuname','Sizes Details')
@section('content')
    ...
    <div class="col-md-4">
      ...
      <div class="box box-widget widget-user">
        ...
        <div class="widget-user-header bg-aqua-active">
          <h3 class="widget-user-username">{{$size->name}}</h3>
        </div>
          ...
          <div class="row">
            <div class="col-sm-4 border-right">
              <div class="description-block">
                <h5 class="description-header">Orden</h5>
                <span class="description-text">{{$size->orden}}</span>
            ...
            <div class="col-sm-4">
              <div class="description-block">
                ...
                <span class="description-text">{{$size->status}}</span>
              </div><!-- /.description-block -->
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div>
            ...
            <div class="col-sm-8">
              <div class="btn-group">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    @can('sizes.index')
                      <a type="button" class="btn btn-info" href="{{route('sizes.index')}}" >Back to List</a>
                    @endcan
                  </div>
                </div>
              </div>
