...
@section('menuname','My-Account')
@section('content')
@guest
    <div class="alert alert-danger"><strong>Oh snap!</strong> <a href="{{ route('login') }}" class="alert-link">No info to display</a> you must be logged.</div>
@else
     <!-- LOGIN SECTION START -->
                                            ...
                                            <div class="new-customers">
                                                <div class="p-30">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text"  placeholder="Phone here..." value="{{ Auth::user()->phone }}">
                                                        </div>
                                                    </div>
