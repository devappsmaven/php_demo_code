<div class="box"  style="background-color:#eaeaea;">
        ...
        <div class="box-body">
            ...
            {{ csrf_field() }}
            <input type="hidden" class="form-control" name="parent_id" value="{{ $childproduct->id }}">
                ...
                <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('fabric') ? ' has-error' : '' }} has-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="fabric" placeholder="Enter name" value="{{ $childproduct->fabric }}" required>
                        </div>
                    ...
                    <div class="form-group{{ $errors->has('min_quantity') ? ' has-error' : '' }} has-feedback">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon">
                                ...
                                <input type="text" class="form-control" name="min_quantity" placeholder="Enter name" value="{{ $childproduct->min_quantity }}" required>
                ...
                <div class="col-sm-3 admin-box">
                    <div class="col-sm-12 admin-box" style="height:auto; margin-left: auto; padding-top: auto;margin-bottom: 35px !important;">
                        ...
                        <div class="col-sm-12" style="height:150px;">
                            <center><img src="{{asset('img/product')}}{{'/'}}{{$childproduct->image}}" id="preview" style="width:auto; height:150px;"></center>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Sizes</label>
                            {!! Form::select('sizes[]' , $sizes , $childproduct->sizes, ['class' => 'form-control',"multiple", "style" =>'height: 260px;','required']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-8 admin-box" style="height:auto;">
                    <input type="hidden" name="productsides" id="productsides">
                    @foreach ($childproduct->sides as $side)
                        @if($side->pivot->enable)
                            <div class="col-sm-3 admin-box" style="margin-bottom:50px !important;">
                                ...
                                <div class="col-sm-12" style="height:150px;">
                                <center><img src="{{asset('img/product')}}{{'/'}}{{$side->pivot->image}}" id="{{$side->slug}}preview" style="width: auto; height: 150px;"></center>
                                </div>
                                <div class="col-sm-12">
                                    <div class="input-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <div class="nav-tabs-custom">
                                                                    <ul class="nav nav-tabs">
                                                                        ...
                                                                        <li><a href="#medialibrary" data-toggle="tab">Media Library</a></li>
                                                                    </ul>
                                                                    <div class="tab-content">
                        ...
                        <div class="col-sm-3 admin-box" style="margin-bottom:50px !important;">
                            ...
                            <div class="col-sm-12" style="height:150px;">
                            <center><img  id="{{$side->slug}}preview" style="width: auto; height: 150px;"></center>
                            </div>
                            <div class="col-sm-12">
                                <div class="input-group">
                                    <span class="input-group-addon">
        ...
        <div class="box-footer" style="background-color:#eaeaea;">
            <div class="form-group">
                {{Form::submit('Update',['class'=>'btn btn-primary btn-sm pull-right',"style" => "padding: 10px 45px; font-size: 18px;"])}}
            </div>
        </div><!-- /.box-footer-->
    </div>
