...
<html>
    ...
    <title>VividCustoms Save Share Design</title>
    <style>
        body {
        background: #ffffff;
    ...
    <body style='text-align: center; color: #0000ff;'>
        ...
        <table align="center">
            <tbody>
                <tr>
                    <td>
                        <a href="http://vividcustoms.com/designstudio/r/{{$design->id}}"  target="_blank" tabindex="0" style="cursor: pointer; background-color: #e62a9a; border: 0 none; text-decoration: none; border-radius: 20px; box-shadow: 0 0 0 1px rgba(79, 193, 240, 0.03) inset; cursor: pointer; display: inline-block; margin-right: 10px; overflow: hidden; padding: 5px 10px; position: relative; background-color: rgba(230, 42, 154, 0.8); color: #ffffff !important; font-size: 15px;">
        ...
        <table style='background: #4598ba none repeat scroll 0 0;' align='center' width='550'>
            <tbody>
                <tr>
                <th style='border-right: 1px solid #eeeeee'><a href='http://vividcustoms.com/designstudio' target='_blank' style='cursor: pointer; text-decoration: none; color: #ffffff !important; height: 40px; line-height: 40px; overflow: hidden; padding: 10px 20px; text-align: center; text-transform: capitalize; white-space: nowrap; width: 50px;'>Designstudio</a></th>
                <th style='border-right: 1px solid #eeeeee'><a href='http://vividcustoms.com/products' target='_blank' style='cursor: pointer; text-decoration: none; color: #ffffff !important; height: 40px; line-height: 40px; overflow: hidden; padding: 10px 20px; text-align: center; text-transform: capitalize; white-space: nowrap; width: 50px;'>Products</a></th>
                <th style='border-right: 1px solid #eeeeee'><a href='http://vividcustoms.com/templatedesign' target='_blank' style='cursor: pointer; text-decoration: none; color: #ffffff !important; height: 40px; line-height: 40px; overflow: hidden; padding: 10px 20px; text-align: center; text-transform: capitalize; white-space: nowrap; width: 50px;'>Design Templates</a></th>
                <th><a href='http://vividcustoms.com/about-us' target='_blank' style='cursor: pointer; color: white; text-decoration: none; color: #ffffff !important; height: 40px; line-height: 40px; overflow: hidden; padding: 10px 20px; text-align: center; text-transform: capitalize; white-space: nowrap; width: 50px;'>About Us</a></th>
                </tr>
                <tr>
                </tr>
            </tbody>
