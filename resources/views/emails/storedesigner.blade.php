...
<html>
    ...
    <title>VividCustoms Verify User</title>
    <style>
        body {
        background: #ffffff;
    ...
    <body style='text-align: center; color: #0000ff;'>
        ...
        <br>
        <h2>Congratulations {{$user['firstname']}} {{$user->lastname}}</h2>
        <br/>
        Your store: "{{$user->store->name}}" was Approved, Please click on the below link to manage your store
        <br/>
        <a href="{{url('my-store')}}">My Store</a>
        <br>
