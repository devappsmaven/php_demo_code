...
<html>
    ...
    <title>VividCustoms Subscriber</title>
    <style>
        body {
        background: #ffffff;
    ...
    <body style='text-align: center; color: #0000ff;'>
        ...
        <br>
        <h2>Welcome to the subscribers group</h2>
        <br/>
        Your registered email-id is {{$subscriber['email']}} , Please click on the below link to verify your email
        <br/>
        <a href="{{url('subscribers/activate', $subscriber->token)}}">Verify Email</a>
        <br>
