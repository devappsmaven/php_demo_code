...
@section('pagename','Edit Promo Code')
@section('menuname','Edit Promo Code')
@section('content')

<div class="row">
        @include('common.alerts')  
        <form role="form" method="POST" action="/admin/promocodes/{{$promocode->id}}" enctype="multipart/form-data">
            {{csrf_field()}}
            {{method_field('PUT')}}
            <div class="col-md-6">
            <!-- Profile Image -->
                    ...
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter name" value="{{ $promocode->name }}">
                            </div>
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }} has-feedback">
                            ...
                            <textarea  class="form-control" name="description" id="description" cols="30" rows="3">{{ $promocode->description }}</textarea>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="amount" placeholder="Enter amount" value="{{ $promocode->amount }}">
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('freeshipping') ? ' has-error' : '' }} has-feedback">
                            <label>
                            <input type="checkbox" class="minimal" name="freeshipping" id="freeshipping" {{ $promocode->freeshipping ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('expirationdate') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                {{Form::text('expirationdate',$promocode->expirationdate,['class'=>'form-control', 'data-inputmask' => '"alias": "mm/dd/yyyy"', 'data-mask' => '','id' => 'expirationdate', 'name' => 'expirationdate'])}}
                            </div>
                    ...
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('minimumspend') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="minimumspend" placeholder="Enter minimum spend" value="{{ $promocode->minimumspend }}">
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('maximumspend') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="maximumspend" placeholder="Enter Maximum Spend" value="{{ $promocode->maximumspend }}">
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('individualuseonly') ? ' has-error' : '' }} has-feedback">
                            <label>
                            <input type="checkbox" class="minimal" name="individualuseonly" id="individualuseonly"  {{ $promocode->individualuseonly ? 'checked' : '' }}>
                            </label>
                        ...
                        <div class="form-group{{ $errors->has('excludesaleitems') ? ' has-error' : '' }} has-feedback ">
                            <label>
                            <input type="checkbox" class="minimal" name="excludesaleitems" id="excludesaleitems"  {{ $promocode->excludesaleitems ? 'checked' : '' }}>
                            </label>
                    ...
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('limitpercoupon') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="limitpercoupon" placeholder="Enter limit per coupon" value="{{ $promocode->limitpercoupon }}">
                            </div>
                        ...
                        <div class="form-group{{ $errors->has('limitperuser') ? ' has-error' : '' }} has-feedback">
                            ...
                            <input type="text" class="form-control" name="limitperuser" placeholder="Enter Limit Per User" value="{{ $promocode->limitperuser }}">
                            </div>
