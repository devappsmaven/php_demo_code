...
@section('title','Templates Categories')
@section('pagename','Templates Categories')
@section('menuname','Templates Categories')
@section('content')
<div class="row" style="margin-top:50px;">    
    ...
    <div class="col-md-6">       
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Templates Categories</h3>
        </div>      
        @include('common.alerts')  
        <form role="form" method="POST" action="{{route('templates.storecategories')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
