...
@section('title','SubCategories Details')
@section('pagename','SubCategories Details')
@section('menuname','SubCategories Details')
@section('content')
  ...
  <div class="col-md-4">
    ...
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-header bg-aqua-active">
        <h3 class="widget-user-username">{{$subcategory->name}}</h3>
      </div>
        ...
        <div class="row">
          <div class="col-sm-4 border-right">
            <div class="description-block">
              ...
              <span class="description-text">{{$subcategory->category->name}}</span>
          ...
          <div class="col-sm-4">
            <div class="description-block">
              ...
              <span class="description-text">{{$subcategory->status}}</span>
            </div><!-- /.description-block -->
          </div><!-- /.col -->
          ...
          <div class="col-sm-4 border-left">
            <div class="description-block">
              ...
              <span class="description-text">{{$subcategory->description}}</span>
            </div><!-- /.description-block -->
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  @can('subcategories.index')
                    <a type="button" class="btn btn-info" href="{{route('subcategories.index')}}" >Back to List</a>
                  @endcan
                </div>
              </div>
            </div>
