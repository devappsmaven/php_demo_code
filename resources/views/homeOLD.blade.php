                ...
                <div class="row active-by-brand slick-arrow-2">
                    ...
                    <div class="col-xs-12">
                        <div class="single-brand-product">
                            <a href="single-product.html"><img src="{{asset('img/frontend//product/5.jpg')}}" alt=""></a>
                    ...
                    <div class="col-xs-12">
                        <div class="single-brand-product">
                            <a href="single-product.html"><img src="{{asset('img/frontend//product/6.jpg')}}" alt=""></a>
                            <h3 class="brand-title text-gray">
                                <a href="#">Brand name</a>
                            </h3>
                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="single-brand-product">
                            <a href="single-product.html"><img src="{{asset('img/frontend//product/7.jpg')}}" alt=""></a>
                            <h3 class="brand-title text-gray">
                                <a href="#">Brand name</a>
                            </h3>
                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="single-brand-product">
                            <a href="single-product.html"><img src="{{asset('img/frontend//product/8.jpg')}}" alt=""></a>
                            <h3 class="brand-title text-gray">
                                <a href="#">Brand name</a>
                            </h3>
                        </div>
                ...
                <div class="row active-featured-product slick-arrow-2">
                        ...
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{asset('img/frontend//product/1.jpg')}}" alt=""/>
                                </a>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{asset('img/frontend//product/2.jpg')}}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                    ...
                    <div class="col-xs-12">
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{asset('img/frontend//product/3.jpg')}}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                    ...
                    <div class="col-xs-12">
                        <div class="product-item">
                            <div class="product-img">
                                <a href="single-product.html">
                                    <img src="{{asset('img/frontend//product/4.jpg')}}" alt=""/>
                                </a>
                            </div>
                            <div class="product-info">
                                <h6 class="product-title">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="up-comming-pro gray-bg clearfix">
                        <div class="up-comming-pro-img f-left">
                            <a href="#">
                                <img src="{{asset('img/frontend//up-comming/1.jpg')}}" alt="">
                            </a>
                        </div>
                ...
                <div class="col-md-4 hidden-sm col-xs-12">
                    <div class="banner-item banner-1">
                        ...
                        <div class="banner-img">
                            <a href="#"><img src="{{asset('img/frontend//banner/1.jpg')}}" alt=""></a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/7.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/9.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/10.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/11.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 hidden-sm col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/8.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 hidden-sm col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/12.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/5.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
                            ...
                            <div class="col-md-3 col-sm-4 col-xs-12">
                                <div class="product-item">
                                    <div class="product-img">
                                        <a href="single-product.html">
                                            <img src="{{asset('img/frontend//product/6.jpg')}}" alt=""/>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <h6 class="product-title">
        ...
        <div class="container">
            ...
            <div class="blog">
                <div class="row active-blog">
                    ...
                    <div class="col-xs-12">
                        <div class="blog-item">
                            <img src="{{asset('img/frontend//blog/1.jpg')}}" alt="">
                            <div class="blog-desc">
                    ...
                    <div class="col-xs-12">
                        <div class="blog-item">
                            <img src="{{asset('img/frontend//blog/2.jpg')}}" alt="">
                            <div class="blog-desc">
                                <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                <div class="read-more">
                    ...
                    <div class="col-xs-12">
                        <div class="blog-item">
                            <img src="{{asset('img/frontend//blog/3.jpg')}}" alt="">
                            <div class="blog-desc">
                                <h5 class="blog-title"><a href="single-blog.html">dummy Blog name</a></h5>
                                <p>There are many variations of passages of psum available, but the majority have suffered alterat on in some form, by injected humour, randomis words which don't look even slightly.</p>
                                <div class="read-more">
