...
@section('title','Open Cart')
@section('pagename','Open Cart')
@section('menuname','Open Cart')
@section('content')
@guest
            ...
            <div class="box-body">
                ...
                <div class="table-responsive mailbox-messages">
                    <table id="opencarttable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($opencarts as $opencart)
                                <tr>
                                    <td class="mailbox-name"><a href=""><input type="checkbox" class="opencart" id="{{$opencart->user->email}}"></a></td>
                                    <td class="mailbox-name"><a href=""><b>{{$opencart->user->firstname}} {{$opencart->user->lastname}}</b></a></td>
                                    <td class="mailbox-name"><a href="">{{$opencart->user->email}}</a></td>
                                    <td class="mailbox-name"><a href="">{{$opencart->updated_at->format('m/d/Y h:m:i')}}</a></td>
                                    <td class="mailbox-name"><a href="">{{$opencarts->today->diffInDays($opencart->updated_at)}}</a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>   
