...
.block{float:left;border:1px solid #eeeeee !important;cursor:pointer;border-radius:50%;margin-right:7px;width:32px !important;height:32px !important;margin-bottom:5px;}
            ...
            <div class="ds-work-area" id="ds-work-area">
                <div class="tab-content">
                            ...
                            <div class="row pl-20">
                                <div class="col-xs-12 dsbutton">
                                    <center>
                                        <li class="ds-li" style="border: 2px solid #ffffff; border-radius: 10px; list-style-type: none;" onclick="deselectAllCanvases();">
                                            <a class="ds-a" data-toggle="tab" href="#productSection">
                                                <span class="">Change Product</span>
                                            </a>
                                        </li>
                                    </center>
                                </div>
                                ...
                                <div class="col-xs-6 dsbutton">
                                        <center>
                                          ...
                                          <a data-toggle="tab" href="javascript:void(0)" class="">Start Over</a>
                                    </li></center>
                                </div>
                               -->
                            </div>
                    ...
                    <div id="productSection" class="tab-pane fade">
                        ...
                        <div class="row ds-panel-body ds-panel-div">
                              ...
                              <div class="col-xs-12">
                                ...
                                <div id="description_label">
                                    ...
                                    <p class="p-workarea mb-10"><strong>Fabric:</strong> {{$product->fabric}}</p>
                            ...
                            <div class="col-xs-12">
                                <div class="col-xs-12 color-div" style="width: 100%;" id="child_product_color_div"><strong>No Minimum</strong> (For Orders Quantity 1-5)<br>
                                    @foreach ($product->parent->colors as $color)
                                        <div id="child_color_minimum_{{$color->id}}" class="block color-{{$color->id}} {{$color->id == $product->color->id ? 'animate' : ''}}" title="{{$color->name}}" style="background-color: {{$color->hex}};" onclick="setcanvasproperties('{{$color->pivot->childproduct_id}}'); setactivecolor(this);"></div>
                                    @endforeach
                                </div>
                                <br><br>
                                <div class="" style="width: 100%;" id="child_product_color_div6"><strong>6 Piece Minimum</strong> (For Orders Quantity 6+)<br>
                                    @foreach ($product->parent->colors as $color)
                                        <div id="child_color_minimum_{{$color->id}}" class="block color-{{$color->id}} {{$color->id == $product->color->id ? 'animate' : ''}}" title="{{$color->Name}}" style="background-color: {{$color->hex}};" onclick="setcanvasproperties('{{$color->pivot->childproduct_id}}'); setactivecolor(this);"></div>
                                    @endforeach
                                </div>
                        ...
                        <!-- END PRODUCTS COLOR -->
                        <div class="col-xs-12">
                          <a type="button" class="ds-btn ds-btn-success ds-entertext form-control mt-15" style="display: block;" id="changeproductbtn" name="changeproductbtn" style="cursor: pointer;" data-toggle="modal" data-target="#productmodal" onclick="">
                              <center>
                                  <span class="" style="">Change Product</span>
                              </center>
                          </a>
                        </div>
                    </div>
                        ...
                        <div id="editArt" style="display: none;" class="ds-panel-body mb-15">
                            <div class="">
                              ...
                              <div class="ds-panel-div pt-5">
                                  <div class="" id="Artcolorink" name="Artcolorink">
                                      ...
                                      <div id="inkcolorlist" class="pl-20">
                                          <div class="block transparent3" id="artcolortransparent" style="background-color: #ffffff; border:2px solid #eeeeee; cursor:pointer" onclick="document.getElementById('Artcolor').innerHTML = 'Transparent'; changecolor('transparent');">
                                          </div>
                                          @foreach($inkcolors as $inkcolor)
                                              <div id="artcolor{{$inkcolor->hex}}" class="block color-{{$inkcolor->id}}" title="{{$inkcolor->name}}" style="background-color: {{$inkcolor->hex}}; cursor:pointer" onclick="document.getElementById('Artcolor').innerHTML = '{{$inkcolor->name}}'; changecolor('{{$inkcolor->hex}}'); ">
                                              </div>
                                          @endforeach
                                      </div>
                                      <br>
                                      ...
                                      <div class="col-xs-12" style="margin-top: 15px; padding-left: 20px;" id="checkcolorlegend">
                                          <span class="animate2"></span> <span class="p-workarea">Indicates a color already in your design</span>
                                      </div>
                                      <br>
                                      <div class="col-xs-12 col-xs-12 col-xs-12" style="padding-left: 20px;" id="artcolortransparentlegend">
                                          <div class="block transparent4" style="border-radius: 50%;  margin-right: 1.7px; background-color: #ffffff; border:2px solid #eeeeee; cursor:pointer;width: 20px !important;height: 20px !important;">
                        ...
                        <div class="" id="new_text">
                            ...
                            <div id="textmenu" style="display: none;">
                                ...
                                <div class="ds-panel-body" >
                                    ...
                                    <div class="">
                                        <div class="col-xs-12 mt-15" style="padding-left: 20px;" id="checkcolorlegend"><span class="animate2"></span>
                                          <span class="p-workarea">Indicates a color already in your design</span>
                                        </div>
                                        <div class="">
                                            <div class="col-xs-12 mt-15" style="">
                                                @foreach($inkcolors as $inkcolor)
                                                    <div id="textcolor{{$inkcolor->hex}}" class="block" title="{{$inkcolor->name}}" style="background-color:{{$inkcolor->hex}}; cursor:pointer" onclick="/*OpenClose('carousel_area','work_area','Textcolor');*/ document.getElementById('Textcolor').innerHTML = '{{$inkcolor->name}}';changecolorText('{{$inkcolor->hex}}','f');">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                        ...
                                        <div id="Outlinediv" class="" style="display: none;">
                                            ...
                                            <div class="">
                                                    <div class="">
                                                        <div class="col-xs-12" style="margin-top:10px;">
                                                            @foreach($inkcolors as $inkcolor)
                                                                <div id="strokecolor{{$inkcolor->hex}}" class="block" title="{{$inkcolor->name}}" style="background-color:{{$inkcolor->hex}}; cursor:pointer" onclick="/*OpenClose('carousel_area','work_area','Textstrokecolor');*/ document.getElementById('Textstrokecolor').innerHTML = '{{$inkcolor->name}}';changecolorText('{{$inkcolor->hex}}','c');">
                                                                </div>
                                                            @endforeach
                                                        </div>
                                                    </div>
...
<!-- Footer Start -->
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="text-align: center;">
                        ...
                        <div class="modal-body" style="background-color: #eeeeee;">
                            ...
                            <div class="" id="panelregister" style="display: none;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="overflow-y: hidden">
                            ...
                            <div class="row save-design" id="SaveShareModalDiv">
                                ...
                                <!--START SHARE SECTION-->
                                <div class="" id="share_div" name="share_div">
                                    <div class="col-xs-12">
    ...
    <script src="{{asset('js/frontend/designstudio/bootstrap.min.js')}}"></script>
    ...
    <script type="text/javascript">
        ...
        function setcanvasproperties(id)
        {
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    description_label += '<p class="p-workarea mb-10"><strong>Fabric:</strong> ' + data.product.fabric + '</p>';
        ...
        */
        ...
        function loadchangeproduct()
        {
            ...
            description_label += '<p class="p-workarea mb-10"><strong>Fabric:</strong> ' + product.fabric + '</p>';
            description_label += '<p><a href="#productlongdescription" data-toggle="collapse" id="more-details" class="collapsestart" onclick="moreless(this);"> More Details </a></p>';
            document.getElementById("description_label").innerHTML = description_label;            
            document.getElementById("productlongdescription").innerHTML = product.description;
            var sidesinfo = "";
            var innersinfo = "";
            var countsides = 0;
            var countinners = 0;
