...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <style type="text/css">
        ...
        .ds-template{
            ...
            .block{float:left;border:1px solid #eeeeee;cursor:pointer;border-radius:50%;margin-right:1.7px;width:30px !important;height:30px !important;border: 1px solid #777777 !important; margin-bottom:5px;}
            ...
            .transparent:after {content: ""; position: absolute; border-top: 1px solid red; width: 30px; transform: rotate(45deg); transform-origin: 0% 0%; margin-left: 3px; margin-top: 2px;}
            ...
            .carousel-control.right{cursor:pointer; right:50px;left:auto;background-image:-webkit-linear-gradient(left,rgba(0,0,0,0) 0,rgba(0,0,0,.0) 100%);background-image:-o-linear-gradient(left,rgba(0,0,0,0) 0,rgba(0,0,0,.0) 100%);background-image:-webkit-gradient(linear,left top,right top,from(rgba(0,0,0,0)),to(rgba(0,0,0,.0)));background-image:linear-gradient(to right,rgba(0,0,0,0) 0,rgba(0,0,0,0) 100%);background-repeat:repeat-x;}
            .carousel-control.left{cursor:pointer; left:50px;background-image:-webkit-linear-gradient(left,rgba(0,0,0,0) 0,rgba(0,0,0,.0) 100%);background-image:-o-linear-gradient(left,rgba(0,0,0,0) 0,rgba(0,0,0,.0) 100%);background-image:-webkit-gradient(linear,left top,right top,from(rgba(0,0,0,0)),to(rgba(0,0,0,.0)));background-image:linear-gradient(to right,rgba(0,0,0,0) 0,rgba(0,0,0,.0) 100%);background-repeat:repeat-x;}
    ...
    <div class="page"  id="app">
                    ...
                    <div id="productsection">
                            <div class="panel">
                                <div class="row ds-panel-body ds-panel-div">
                                    ...
                                    <div class="col-xs-12">
                                            <h5 id="product_name" class="product-titlenew">{{$product->parent->name}}</h5>
                                            <div id="description_label">
                                                <p class="p-workarea"><strong>Brand:</strong> {{$product->brand}} </p>
                                                <p class="p-workarea"><strong>Size:</strong> YXS-5XL  <a href="javascript:void(0)" id="btnmodal" data-toggle="modal" data-target="#sizechartmodal"> size chart</a></p>
                                    ...
                                    <div id="productlongdescription" class="col-xs-12  collapse">
                                        {!!$product->description!!}
                                    </div>
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                   <span id="current_selected_product_color"></span>
                                    <br>
                                    <span class="product-colortitle">Current Product Color:</span> <span id="current_product_color" class="product-color uppercase">  {{$product->color->name}}</span>
                                </div>
                                <div class="panel-body">
                                    <div class="row" style="width: 100%; margin: 0 auto;" id="child_product_color_div"><strong>No Minimum</strong> (For Orders Quantity 1-5)<br>
                                    ...
                                    <br>
                                    <div class="row" style="width: 100%; margin: 0 auto;" id="child_product_color_div6"><strong>6 Piece Minimum</strong> (For Orders Quantity 6+)<br>
                                        @foreach ($product->parent->colors as $color)
                                            <div id="child_color_minimum_{{$color->id}}" class="block color-{{$color->id}} {{$color->id == $product->color->id ? 'animate' : ''}}" title="{{$color->Name}}" style="border-radius: 50%; background-color: {{$color->hex}}; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;" onclick="setcanvasproperties('{{$color->pivot->childproduct_id}}'); setactivecolor(this);"></div>    
                                        @endforeach
                                    </div>
                                    <hr>
                                    <a type="button" id="changeproductbtn" name="changeproductbtn" style="cursor: pointer;" href="javascript:void(0)" onclick="document.getElementById('listproduct').style.display = 'block'; document.getElementById('singleproduct').style.display = 'none'; document.getElementById('btn-done').style.display = 'none';document.getElementById('changeproductdiv').style.display = 'block'; document.getElementById('productsection').style.display = 'none';/*document.getElementById('listproduct').style.display = 'block'; document.getElementById('singleproduct').style.display = 'none';  document.getElementById('sortby-filter').style.display = 'none'; document.getElementById('results').style.display = 'none';*/ ">
                                        <center>
                                            <span class="" style="color: #ffffff !important; background-color: #e63d90; padding: 8px 30px; border-radius: 8px; margin-left: auto; margin-right: auto; text-align: center; font-size: 1.8rem;">
                                                Change Product
                                            </span>
                                        </center>
                                    </a>
                    ...
                    <div id="loaderOnly" class="loaderSave" style="display: none;"></div>
                        ...
                        <div id="savesharediv">
                            ...
                            <hr style="margin-top: 10px; margin-bottom: 10px; background-color: #4598ba; height: 2px; border: 0;">
                                <!--SHARE SECTION-->
                                <div class="panel" id="share_div" name="share_div">
                                    <div class="col-xs-12">
                                    <div class="panel-heading">
                                        <center>
        ...
        <div class="ds-work-area-edit" id="ds-work-area-edit" style="display: none;">
            ...
            <div class="ds-work-area-edit-element" id="ds-div-artresize">
                ...
                <div class="ds-work-area-edit-element-body">
                    <center>
                        <i class="fa fa-lock" id="resizeicon" style="font-size:30px;color:#31b0d5; cursor: pointer;" onclick="SetScaleProportional();"></i>
                    </center>
                    <div class="col-xs-12">
            ...
            <div class="ds-design-area col-xs-7" id="ds-design-area">
                <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="false">
                    <ol class="undoredo">
                        ...
                        <li  name="clone" id="clone" style="border: 0px solid #696973;" onclick="copyclipart();">
                           <span class="glyphicon glyphicon-plus ds-rvpadding"></span>
                            <br>
                            <span class="ds-right-font" style="font-size: 10px !important;">Copy Layer</span>
                        </li>
                    </ol>
                    ...
                    <a class="left carousel-control" >
                        <span class="glyphicon glyphicon-chevron-left" style="color: #31B0D5; font-size: 45px;" href="#myCarousel" data-slide="prev" onclick="setcanvas('previous');"></span>
                        <span class="sr-only">Previous</span>
                    </a>
                    <a class="right carousel-control">
                        <span class="glyphicon glyphicon-chevron-right" style="color: #31B0D5; font-size: 45px;" href="#myCarousel" data-slide="next" onclick="setcanvas('next');"></span>
                ...
                if (modifiedObject.id.toString().indexOf("uploaded") == -1) 
                {
                        ...
                        if (modifiedObject.numbercolors != undefined) 
                        {
                            ...
                            else
                            {
                                ...
                                for (var i = 0; i < modifiedObject.colorlist.length; i++) 
                                {
                                    ...
                                    objectcolors2.innerHTML += '<div id="color2_'+modifiedObject.id+'" class="color1 '+transparent +'" style="background-color: '+ currentcolor+'; width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;"></div>';
                                }
                    ...
                    else
                    {
                        if (modifiedObject.numbercolors != undefined) 
                        {
                            ...
                            else
                            {
                                ...
                                for (var i = 0; i < modifiedObject.colorlist.length; i++) 
                                {
                                    ...
                                    objectcolors2.innerHTML += '<div class="color1 '+transparent+'" style="background-color: '+ currentcolor+'; width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;"></div>';
                                }
                                displaycolor.style.display = "block";
                        ...
                        else if (modifiedObject.filters.length > 0) 
                        {
                            ...
                            var Artcolor_name = found.name;
                            objectcolors2.innerHTML = '<div class="color1" style="background-color: '+ rgb2hex(modifiedObject.filters[modifiedObject.filters.length - 1].color)+'; width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;"></div>';
                            Artcolor.innerHTML = Artcolor_name;
                            displaycolor.style.display = "block";
                            displaynoeditcolor.style.display = "block";
                            removewhite.style.display = "block";
                        ...
                        else 
                        {
                            ...
                            objectcolors2.innerHTML = '<div class="color1" style="background-color: rgb(0, 0, 0); width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;"></div>';
                            Artcolor.innerHTML = "Black";
                            displaycolor.style.display = "block";
                            displaynoeditcolor.style.display = "block";
                            removewhite.style.display = "block";
            ...
            else if (e.target.type == 'group') 
            {
                ...
                if (modifiedObject.id.indexOf("editable") >=0) 
                {
                    if (layerscolors.length > 0 && layerscolors.length < 2 )
                    {
                        ...
                        for (var i = 0; i < layerscolors.length; i++) 
                        {
                            ...
                            objectcolors2.innerHTML += '<div id="color2_'+layerscolors[i].id.split(".")[0]+'" class="color1 '+transparent+'" style="background-color: '+ currentcolor+'; width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;" onclick="setcolor(this);"></div>';
                        }
                        displaycolor.style.display = "block";
                        displaynoeditcolor.style.display = "none";
                ...
                else
                {
                    if (layerscolors.length > 0 && layerscolors.length < 2 )
                    {
                        ...
                        {
                            var currentcolor = layerscolors[i].fill;
                                objectcolors2.innerHTML += '<div class="color1" style="background-color: '+ currentcolor+'; width: 30px; height: 30px; border-radius: 30px; display: inline-flex; border: 1px solid rgb(238, 238, 238); cursor: pointer;"></div>';
                        }
                        displaycolor.style.display = "none";
                        displaynoeditcolor.style.display = "block";
                        removewhite.style.display = "none";
                ...
                {  
                    ...
                    if(product.parent.colors.length > 0)
                    {
                        ...
                        product.parent.colors.forEach(color => {
                            ...
                            {
                                colorminimum += '<div id="child_color_minimum_' + color.id + '" title="' + color.name +'" onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" class="block block-product ' + animate + '" style="border-radius: 50%; background-color: ' + color.hex + '; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;"></div>';
                            }
                            colorminimum6 += '<div id="child_color_minimum_' + color.id + '" title="'+ color.name +'" onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" class="block actionblock-product ' + animate + '" style="border-radius: 50%; background-color: ' + color.hex + '; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;"></div>';
                            }
                            else
                            {
                            if(color.pivot.min_quantity == 1)
                            {
                                colorminimum += '<img onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" src="' + window.location.origin + '/img/color/' + color.file + '" id="child_color_minimum_' + color.id + '" class="block block-product ' + animate + '" style="width: 30px; position: relative; height: 30px; border: 0px solid rgb(238, 238, 238); border-radius: 50%; cursor: pointer;">';
                            }
                            colorminimum6 += '<img onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" src="' + window.location.origin + '/img/color/' + color.file + '" id="child_color_minimum_' + color.id + '" class="block block-product ' + animate + '" style="width: 30px; position: relative; height: 30px; border: 0px solid rgb(238, 238, 238); border-radius: 50%; cursor: pointer;">';
                            }
                        });
            ...
            if(product.parent.colors.length > 0)
            {
                ...
                product.parent.colors.forEach(color => {
                    ...
                    if(color.hex != null)
                    {
                      ...
                      colorminimum6 += '<div id="child_color_minimum_' + color.id + '" title="'+ color.name +'" onclick="setcanvasproperties(' + color.pivot.childproduct_id + '); setactivecolor(this,`-product`);" class="block block-product ' + animate + '" style="border-radius: 50%; background-color: ' + color.hex + '; width: 30px; height: 30px; border: 0px solid rgb(238, 238, 238); cursor: pointer; margin-right: 1.7px;"></div>';
                    }
                    else
                    {
                      if(color.pivot.min_quantity == 1)
