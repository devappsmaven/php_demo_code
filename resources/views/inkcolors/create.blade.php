...
@section('title','Create Ink Color')
@section('pagename','Create Ink Color')
@section('menuname','Create Ink Color')
@section('content')
<div class="row" style="margin-top:50px;">    
    ...
    <div class="col-md-6">       
        ...
        <form role="form" method="POST" action="{{route('inkcolors.store')}}" enctype="multipart/form-data"  class="colors_form" novalidate="novalidate">
            {{csrf_field()}}
            <div class="box-body">
