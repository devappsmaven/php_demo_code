...
<div class="box">
   ...
   <div class="box-header">
    <h3 class="box-title">Price Shirt Table Embroidery</h3>
      @can('pricediscounttableembroidery.edit')
        <a href="{{route('pricediscounttableembroidery.edit')}}" class="btn-warning  btn-sm pull-right">
            Edit
        </a>
      @endcan
    </div><!-- /.box-header -->
    ...
    <div class="box-body">
      <table class="table table-bordered">
        <tbody>
          ...
          <tr>
            @foreach ($pricediscounttableembroidery as $item)
