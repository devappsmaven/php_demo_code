...
@section('title','Fonts Details')
@section('pagename','Fonts Details')
@section('menuname','Fonts Details')
@section('content')
  ...
  <div class="col-md-4">
    ...
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-header bg-aqua-active">
        <h3 class="widget-user-username"><font class="fonts"  face="{{ $font->name }}" size="{{ $font->size }}">{{$font->displayname}}</font></h3>
      </div>
        ...
        <div class="row">
          <div class="col-sm-4 border-right">
            <div class="description-block">
              ...
              <span class="description-text">{{$font->category->name}}</span>
          ...
          <div class="col-sm-4">
            <div class="description-block">
              ...
              <span class="description-text">{{$font->status}}</span>
            </div><!-- /.description-block -->
          </div><!-- /.col -->
          ...
          <div class="col-sm-8">
            <div class="btn-group">
              <div class="row">
                ...
                <div class="col-md-4">
                  @can('fonts.index')
                    <a type="button" class="btn btn-info" href="{{route('fonts.index')}}" >Back to List</a>
                  @endcan
                </div>
              </div>
            </div>
