...
@section('title','Galleries Categories')
@section('pagename','Galleries Categories')
@section('menuname','Galleries Categories')
@section('content')
<div class="row" style="margin-top:50px;">    
    ...
    <div class="col-md-6">       
        ...
        <div class="box-header with-border">
            <h3 class="box-title">Galleries Categories</h3>
        </div>      
        @include('common.alerts')  
        <form role="form" method="POST" action="{{route('gallerys.addcategories')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
