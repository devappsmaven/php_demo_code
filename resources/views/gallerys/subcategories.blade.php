...
@section('title','Galleries SubCategories')
@section('pagename','Galleries SubCategories')
@section('menuname','Galleries SubCategories')
@section('content')
<div class="row" style="margin-top:50px;">    
    ...
    <div class="col-md-6">       
        ...
        <form role="form" method="POST" action="{{route('gallerys.addsubcategories')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="box-body">
