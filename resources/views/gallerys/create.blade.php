...
<div class="container-fluid">
    <form role="form" method="POST" action="{{route('gallerys.store')}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-sm-8">
                            ...
                            <div class="modal-dialog" style="width:95%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-info waves-effect remove-data-from-delete-form" data-dismiss="modal">Insert Into Gallery</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <!--<div class="form-group">
                            ...
                            <select class="form-control" multiple data-placeholder="Select a Category" style="width: 100%;" name="categories[]">
                        ...
                        <div class="form-group">
                            <label>Tags</label>
                            <select class="form-control" multiple data-placeholder="Select a tag" style="width: 100%;" name="tags[]">
                                @foreach ($tags as $tag)
