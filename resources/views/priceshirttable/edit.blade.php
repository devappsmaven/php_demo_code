...
@section('title','Edit Price Shirt Table')
@section('pagename','Edit Price Shirt Table')
@section('menuname','Edit Price Shirt Table')
@section('content')
<div class="box">
    <div class="box-header">
      <h3 class="box-title">Edit Price Shirt Table</h3>
      {!!Form::model($priceshirttable,['route' => ['priceshirttable.update'], 'method' => 'PUT'])!!}
        {{ csrf_field() }}
      ...
      @can('priceshirttable.create')
          <a href="{{route('priceshirttable.create')}}" class="btn-success  btn-sm pull-right">Generate</a>
      @endcan
