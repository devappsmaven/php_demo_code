    ...
    <div class="page"  id="app">
        ...
        <div class="ds-container">
            <div class="ds-menu" id="ds-menu">
                ...
                @guest
                    <li  class="ds-li" id="personalizeLI" style="border: 2px solid #ffffff; border-radius: 10px;" onclick="displaypersonalize('backCanvas', true);">
            ...
            <div class="ds-work-area" id="ds-work-area">
                <div class="tab-content">
                    ...
                    <div id="personalizediv" class="tab-pane fade panelshadow">
