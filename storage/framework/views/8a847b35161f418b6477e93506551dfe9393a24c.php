<div class="logo_responsive">
    ...
    <div class="banner_bg">
    <img src="<?php echo e(asset('images/banner-bg.png')); ?>" alt="" title=""/>
    <div class="container">
        <div class="row">
            <div class="slider">
                ...
                <a class="slider_btn" href="<?php echo e(url('designstudio')); ?>">Start Designing</a>
            </div>
        </div>
    </div>
    </div>
                    ...
                    <div class="product-item">
                        <div class="product-img">
                            <a href="<?php echo e(route('single-product', $product->id)); ?>">
                                <img src="<?php echo e(asset('img/product')); ?><?php echo e('/'); ?><?php echo e($product->image); ?>" alt="">
                            </a>
                        </div>
                        <div class="product-info">
                            <h6 class="product-title">
                            <a href="<?php echo e(route('single-product', $product->id)); ?>"><?php echo e($product->name); ?> </a>
                            </h6>
                            ...
                            <ul class="action-button">
                                <li>
                                    <a href="javascript:void(0)" title="<?php echo e($product->favorite_to_users->count()); ?> Favorite" tabindex="0"><i class="zmdi zmdi-favorite"></i></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" title="<?php echo e($product->view_count); ?> view" tabindex="0"><i class="zmdi zmdi-eye"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
