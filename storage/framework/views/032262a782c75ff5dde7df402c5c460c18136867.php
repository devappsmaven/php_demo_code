...
<html>
    ...
    <title>Vivid Customs New Seller Request</title>
    <style>
        body {
        background: #ffffff;
    ...
    <body style='text-align: center; color: #0000ff;'>
        ...
        Hi Admin,
        <br><br>
        New Seller Request has been received. Seller Information are as following :
        <br><br>
        Store Name : <?php echo e($store->name); ?>

        <br><br>
        Please Accept or Decline this Request from the Admin Panel.
        <br/>
